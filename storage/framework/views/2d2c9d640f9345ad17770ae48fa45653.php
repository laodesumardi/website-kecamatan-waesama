    ...
    <div class="bg-[#001d3d] rounded-lg shadow-sm p-4 mb-6">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="flex-1 max-w-md">
                <form method="GET" action="<?php echo e(route('admin.penduduk.index')); ?>" class="flex gap-2">
            ...
            <div class="flex gap-2">
                ...
                <!-- Add Button -->
                <a href="<?php echo e(route('admin.penduduk.create')); ?>" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors flex items-center gap-2">
    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="bg-blue-50 border-b border-blue-100 px-4 py-3 flex items-center justify-between text-sm">
            ...
            <div class="text-blue-600 text-xs font-medium">
                Total: <?php echo e($penduduk->total()); ?> data
            </div>
        </div>
                    ...
                    <tbody class="table-body">
                        <?php $__empty_1 = true; $__currentLoopData = $penduduk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="table-row">
                                ...
                                <td class="table-cell data-cell">
                                    <div class="cell-content">
                                        <div class="font-medium text-gray-900"><?php echo e($item->nama_lengkap); ?></div>
                                    </div>
                                </td>
                                <td class="table-cell data-cell">
                                    <div class="cell-content">
                                        <div class="text-sm"><?php echo e($item->tempat_lahir); ?></div>
                                        <div class="text-xs text-gray-500"><?php echo e($item->tanggal_lahir->format('d/m/Y')); ?></div>
                                    </div>
                                </td>
                                <td class="table-cell data-cell">
                                    <div class="cell-content">
                                        <div class="flex items-center gap-2">
                                            <i class="fas <?php echo e($item->jenis_kelamin == 'L' ? 'fa-mars text-blue-500' : 'fa-venus text-pink-500'); ?>"></i>
                                            <span><?php echo e($item->jenis_kelamin == 'L' ? 'Laki-laki' : 'Perempuan'); ?></span>
                                        </div>
                                    </div>
                                </td>
                                <td class="table-cell data-cell">
                                    <div class="cell-content">
                                        <div class="text-sm" title="<?php echo e($item->alamat); ?>"><?php echo e(Str::limit($item->alamat, 40)); ?></div>
                                        <div class="text-xs text-gray-500"><?php echo e($item->desa_kelurahan); ?></div>
                                    </div>
                                </td>
                                <td class="table-cell data-cell">
                                    <div class="cell-content">
                                        <span class="text-sm">RT <?php echo e($item->rt); ?>/RW <?php echo e($item->rw); ?></span>
                                    </div>
                                </td>
                                <td class="table-cell data-cell">
                                    <div class="cell-content">
                                        <span class="text-sm"><?php echo e($item->agama ?? '-'); ?></span>
                                    </div>
                                </td>
                                <td class="table-cell data-cell">
                                    <div class="cell-content">
                                        <span class="text-sm"><?php echo e($item->pekerjaan ?? '-'); ?></span>
                                    </div>
                                </td>
                                <td class="table-cell data-cell">
                                    <div class="cell-content">
                                        <span class="status-badge status-<?php echo e(strtolower($item->status_penduduk)); ?>">
                                            <i class="fas <?php echo e($item->status_penduduk == 'Tetap' ? 'fa-check-circle' : ($item->status_penduduk == 'Pindah' ? 'fa-exchange-alt' : 'fa-times-circle')); ?>"></i>
                                ...
                                <td class="table-cell data-cell action-column">
                                    <div class="cell-content">
                                        <div class="action-buttons">
                                            <a href="<?php echo e(route('admin.penduduk.show', $item)); ?>"
                                               class="action-btn view-btn" title="Lihat Detail">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="<?php echo e(route('admin.penduduk.edit', $item)); ?>"
                                               class="action-btn edit-btn" title="Edit">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <form action="<?php echo e(route('admin.penduduk.destroy', $item)); ?>" method="POST" class="inline" onsubmit="return confirm('Yakin ingin menghapus data ini?')">
                                                <?php echo csrf_field(); ?>
                            ...
                            <tr>
                                <td colspan="10" class="empty-state">
                                    <div class="empty-content">
                                        ...
                                        <a href="<?php echo e(route('admin.penduduk.create')); ?>" class="empty-action">
                                            <i class="fas fa-plus"></i>
        ...
        <?php if($penduduk->hasPages()): ?>
            <div class="pagination-wrapper">
                <div class="pagination-info">
                    <span>Menampilkan <?php echo e($penduduk->firstItem() ?? 0); ?> sampai <?php echo e($penduduk->lastItem() ?? 0); ?> dari <?php echo e($penduduk->total()); ?> data</span>
                </div>
...
<div id="importModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3">
            ...
            <!-- Modal Body -->
            <form action="<?php echo e(route('admin.penduduk.import')); ?>" method="POST" enctype="multipart/form-data" id="importForm">
                <?php echo csrf_field(); ?>
                <div class="mb-4">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\admin\penduduk\index.blade.php ENDPATH**/ ?>