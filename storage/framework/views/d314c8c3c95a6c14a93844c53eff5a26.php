    ...
    <div class="bg-[#001d3d] rounded-xl p-6 card-shadow border border-[#001d3d]">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-white mt-1"><?php echo e(number_format($stats['total_users'])); ?></p>
            </div>
    ...
    <div class="bg-[#001d3d] rounded-xl p-6 card-shadow border border-[#001d3d]">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-white mt-1"><?php echo e(number_format($stats['total_penduduk'])); ?></p>
            </div>
    ...
    <div class="bg-[#001d3d] rounded-xl p-6 card-shadow border border-[#001d3d]">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-white mt-1"><?php echo e(number_format($stats['pending_surat'])); ?></p>
            </div>
        ...
        <div class="mt-4 flex items-center text-sm text-gray-300">
            Total: <?php echo e(number_format($stats['total_surat'])); ?> surat
        </div>
    </div>
    ...
    <div class="bg-[#001d3d] rounded-xl p-6 card-shadow border border-[#001d3d]">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-white mt-1"><?php echo e(number_format($stats['active_antrian'])); ?></p>
            </div>
        ...
        <div class="mt-4 flex items-center text-sm text-gray-300">
            Total: <?php echo e(number_format($stats['total_antrian'])); ?> antrian
        </div>
    </div>
</div>
    ...
    <div class="bg-[#001d3d] rounded-xl p-6 card-shadow border border-[#001d3d]">
        ...
        <div class="space-y-3 text-white">
            <div class="flex justify-between">
                ...
                <span class="font-semibold"><?php echo e(number_format($stats['total_berita'])); ?></span>
            </div>
            <div class="flex justify-between">
                <span class="text-gray-300">Dipublikasi</span>
                <span class="font-semibold text-emerald-400"><?php echo e(number_format($stats['published_berita'])); ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="bg-[#001d3d] rounded-xl p-6 card-shadow border border-[#001d3d]">
        ...
        <div class="space-y-3 text-white">
            <div class="flex justify-between">
                ...
                <span class="font-semibold"><?php echo e(number_format($stats['total_pengaduan'])); ?></span>
            </div>
            <div class="flex justify-between">
                <span class="text-gray-300">Pending</span>
                <span class="font-semibold text-amber-400"><?php echo e(number_format($stats['pending_pengaduan'])); ?></span>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\admin\dashboard.blade.php ENDPATH**/ ?>