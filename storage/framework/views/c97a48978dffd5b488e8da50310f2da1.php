    ...
    <div class="flex items-center justify-between">
        <div>
            <nav class="flex items-center space-x-2 text-sm text-blue-200 mb-2">
                ...
                <a href="<?php echo e(route('pegawai.penduduk.index')); ?>" class="hover:text-white">Data Penduduk</a>
                <i class="fas fa-chevron-right text-xs"></i>
                <span class="text-white">Detail</span>
            </nav>
            <h2 class="text-2xl font-bold mb-2">Detail Data Penduduk</h2>
            <p class="text-blue-100">Informasi lengkap data penduduk <?php echo e($penduduk->nama_lengkap); ?></p>
        </div>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-xl p-6 card-shadow">
            ...
            <div class="space-y-2">
                <a href="<?php echo e(route('pegawai.penduduk.index')); ?>" class="w-full px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors flex items-center gap-2 justify-center">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\pegawai\penduduk\show.blade.php ENDPATH**/ ?>