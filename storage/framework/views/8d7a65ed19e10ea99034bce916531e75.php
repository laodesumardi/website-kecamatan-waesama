            ...
            <div id="user-info" class="p-4 border-b border-gray-200 sidebar-transition">
                <div class="flex items-center space-x-3">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="font-medium text-gray-800 truncate"><?php echo e(auth()->user()->name); ?></p>
                        <p class="text-sm text-gray-500 truncate"><?php echo e(auth()->user()->role->display_name); ?></p>
                    </div>
                </div>
            </div>
    ...
    <div id="main-content" class="flex flex-col transition-all duration-300 h-screen main-content-expanded">
        ...
        <header class="bg-white shadow-sm border-b border-gray-200 py-4">
            <div class="flex items-center justify-between px-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800"><?php echo $__env->yieldContent('title', 'Dashboard'); ?></h1>
                    <?php if (! empty(trim($__env->yieldContent('subtitle')))): ?>
                        <p class="text-gray-600 text-sm mt-1"><?php echo $__env->yieldContent('subtitle'); ?></p>
                    <?php endif; ?>
                </div>
                        ...
                        <div id="profile-dropdown" class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 z-50 hidden">
                            <div class="p-2">
                                <div class="px-3 py-2 border-b border-gray-100">
                                    ...
                                    <p class="text-xs text-gray-400"><?php echo e(auth()->user()->role->display_name); ?></p>
                                </div>
                                <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-md">
...
</html><?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\layouts\warga.blade.php ENDPATH**/ ?>