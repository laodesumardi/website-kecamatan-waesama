...
<head>
    ...
    <meta property="og:description" content="<?php echo e($berita->excerpt ?: Str::limit(strip_tags($berita->konten), 150)); ?>">
    <meta property="og:type" content="article">
    <meta property="og:url" content="<?php echo e(url()->current()); ?>">
    <?php if($berita->gambar): ?>
        <meta property="og:image" content="<?php echo e(asset('storage/' . $berita->gambar)); ?>">
    <?php endif; ?>
    ...
    <div class="bg-white border-b mt-16 lg:mt-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <nav class="flex items-center space-x-2 text-sm">
                <a href="<?php echo e(url('/')); ?>" class="text-gray-500 hover:text-primary-600 transition-colors">Beranda</a>
                <i class="fas fa-chevron-right text-gray-400 text-xs"></i>
                <a href="<?php echo e(route('public.berita')); ?>" class="text-gray-500 hover:text-primary-600 transition-colors">Berita</a>
                <i class="fas fa-chevron-right text-gray-400 text-xs"></i>
                <span class="text-gray-800 font-medium"><?php echo e(Str::limit($berita->judul, 50)); ?></span>
            </nav>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <article class="lg:col-span-3">
                <div class="bg-white rounded-xl shadow-sm overflow-hidden fade-in">
                    <?php if($berita->gambar): ?>
                        <img src="<?php echo e(asset('storage/' . $berita->gambar)); ?>" alt="<?php echo e($berita->judul); ?>" class="w-full h-64 md:h-96 object-cover">
                    <?php endif; ?>
                    ...
                    <div class="p-6 md:p-8">
                        ...
                        <!-- Title -->
                        <h1 class="text-3xl md:text-4xl font-bold text-gray-900 mb-6 leading-tight"><?php echo e($berita->judul); ?></h1>
                        
                        <!-- Excerpt -->
                        <?php if($berita->excerpt): ?>
                            <div class="bg-gray-50 p-6 rounded-lg mb-8">
                                <p class="text-lg text-gray-700 font-medium leading-relaxed"><?php echo e($berita->excerpt); ?></p>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="mt-8 pt-6 border-t border-gray-200">
                            ...
                            <div class="flex flex-wrap gap-3">
                                <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(urlencode(url()->current())); ?>" target="_blank" class="share-btn inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
                                    <i class="fab fa-facebook-f mr-2"></i>
                                    Facebook
                                </a>
                                <a href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode(url()->current())); ?>&text=<?php echo e(urlencode($berita->judul)); ?>" target="_blank" class="share-btn inline-flex items-center px-4 py-2 bg-sky-500 text-white rounded-lg hover:bg-sky-600 transition-colors">
                                    <i class="fab fa-twitter mr-2"></i>
                                    Twitter
                                </a>
                                <a href="https://wa.me/?text=<?php echo e(urlencode($berita->judul . ' - ' . url()->current())); ?>" target="_blank" class="share-btn inline-flex items-center px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors">
                                    <i class="fab fa-whatsapp mr-2"></i>
                                    WhatsApp
                                </a>
                                <button onclick="copyToClipboard('<?php echo e(url()->current()); ?>')" class="share-btn inline-flex items-center px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors">
                            ...
                            <?php $__currentLoopData = $relatedNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <article class="bg-white rounded-xl shadow-sm overflow-hidden news-card">
                                    <?php if($related->gambar): ?>
                                        <img src="<?php echo e(asset('storage/' . $related->gambar)); ?>" alt="<?php echo e($related->judul); ?>" class="w-full h-48 object-cover">
                                    <?php endif; ?>
                                    <div class="p-6">
                                        <div class="flex items-center text-gray-500 text-sm mb-3">
                                            <i class="fas fa-calendar mr-2"></i>
                                            <span><?php echo e($related->published_at ? $related->published_at->format('d M Y') : $related->created_at->format('d M Y')); ?></span>
                                        </div>
                                        <h3 class="text-xl font-bold text-gray-900 mb-3 hover:text-primary-600 transition-colors">
                                            <a href="<?php echo e(route('public.berita.detail', $related->slug)); ?>"><?php echo e($related->judul); ?></a>
                                        </h3>
                                        <?php if($related->excerpt): ?>
                                            <p class="text-gray-600 mb-4"><?php echo e(Str::limit($related->excerpt, 100)); ?></p>
                                        <?php else: ?>
                                            <p class="text-gray-600 mb-4"><?php echo e(Str::limit(strip_tags($related->konten), 100)); ?></p>
                                        <?php endif; ?>
                                        
                                        <a href="<?php echo e(route('public.berita.detail', $related->slug)); ?>" class="inline-flex items-center text-primary-600 hover:text-primary-800 font-medium transition-colors">
                                            Baca Selengkapnya
                            ...
                            <?php $__currentLoopData = $latestNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $latest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <article class="border-b border-gray-200 pb-4 last:border-b-0 last:pb-0">
                                    <h4 class="text-sm font-medium text-gray-900 mb-2 hover:text-primary-600 transition-colors">
                                        <a href="<?php echo e(route('public.berita.detail', $latest->slug)); ?>"><?php echo e(Str::limit($latest->judul, 60)); ?></a>
                                    </h4>
                                    <div class="flex items-center text-xs text-gray-500">
                                        <i class="fas fa-calendar mr-1"></i>
                                        <span><?php echo e($latest->published_at ? $latest->published_at->format('d M Y') : $latest->created_at->format('d M Y')); ?></span>
                                    </div>
                                </article>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
    ...
    <footer class="bg-gray-900 text-white py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-400">
                <p>&copy; <?php echo e(date('Y')); ?> Kantor Camat Waesama. Semua hak dilindungi.</p>
            </div>
        </div>
    </footer>
...
</html><?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\public\berita-detail-new.blade.php ENDPATH**/ ?>