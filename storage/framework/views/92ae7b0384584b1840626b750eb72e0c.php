...
<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-white rounded-xl p-6 card-shadow">
        <div class="flex items-center gap-4">
            <a href="<?php echo e(route('warga.surat.list')); ?>" 
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            ...
            <div class="bg-white rounded-xl p-6 card-shadow mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="text-gray-900 font-mono"><?php echo e($surat->nomor_surat); ?></p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-gray-900"><?php echo e($surat->created_at->format('d F Y, H:i')); ?></p>
                    </div>
                    
                    <?php if($surat->tanggal_selesai): ?>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Tanggal Selesai</label>
                        <p class="text-gray-900"><?php echo e($surat->tanggal_selesai->format('d F Y, H:i')); ?></p>
                    </div>
                    <?php endif; ?>
            ...
            <div class="bg-white rounded-xl p-6 card-shadow mb-6">
                ...
                <p class="text-gray-700 leading-relaxed"><?php echo e($surat->keperluan); ?></p>
            </div>
            ...
            <div class="bg-white rounded-xl p-6 card-shadow mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="text-gray-900"><?php echo e($surat->nama_pemohon); ?></p>
                    </div>
                    
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">NIK</label>
                        <p class="text-gray-900 font-mono"><?php echo e($surat->nik_pemohon); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-xl p-6 card-shadow">
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    <p class="text-gray-700 leading-relaxed"><?php echo e($surat->catatan); ?></p>
                </div>
            </div>
            <?php endif; ?>
        </div>
            ...
            <div class="bg-white rounded-xl p-6 card-shadow mb-6">
                ...
                <div class="space-y-3">
                    <?php if($surat->status == 'Selesai' && $surat->file_surat): ?>
                        <a href="<?php echo e(route('warga.surat.download', $surat)); ?>" 
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-500"><?php echo e($surat->created_at->format('d F Y, H:i')); ?></p>
                        </div>
                    </div>
                    ...
                    <?php if($surat->status != 'Pending'): ?>
                    <div class="flex items-start gap-3">
                        <div class="flex-shrink-0 w-8 h-8 <?php echo e($surat->status == 'Ditolak' ? 'bg-red-100' : 'bg-primary-100'); ?> rounded-full flex items-center justify-center">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-500"><?php echo e($surat->updated_at->format('d F Y, H:i')); ?></p>
                            <?php if($surat->processor): ?>
                                <p class="text-sm text-gray-500">oleh <?php echo e($surat->processor->name); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-500"><?php echo e($surat->tanggal_selesai ? $surat->tanggal_selesai->format('d F Y, H:i') : $surat->updated_at->format('d F Y, H:i')); ?></p>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\warga\surat\show.blade.php ENDPATH**/ ?>