            ...
            <div class="flex justify-between items-center py-4">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <div class="flex space-x-2">
                        <a href="<?php echo e(route('welcome')); ?>" class="public-nav-item active"><i class="fas fa-home mr-2"></i>Beranda</a>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            <div class="fade-in">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="<?php echo e(route('public.layanan')); ?>" class="btn-primary">
                        <i class="fas fa-cogs mr-2"></i>Lihat Layanan
                    </a>
                    <a href="<?php echo e(route('public.berita')); ?>" class="btn-primary" style="background: rgba(255,255,255,0.2); backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.3);">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1">
                ...
                <div class="bg-white rounded-lg shadow-lg p-6 mb-8">
                    ...
                    <div class="space-y-3">
                        <a href="<?php echo e(route('public.layanan')); ?>" class="block p-3 bg-gray-50 rounded-lg hover:bg-blue-50 transition-colors">
                            <div class="flex items-center">
                                <i class="fas fa-cogs text-blue-600 mr-3"></i>
                                <span class="text-gray-700 hover:text-blue-600">Layanan Publik</span>
                            </div>
                        </a>
                        <a href="<?php echo e(route('public.berita')); ?>" class="block p-3 bg-gray-50 rounded-lg hover:bg-blue-50 transition-colors">
                            <div class="flex items-center">
                                <i class="fas fa-newspaper text-blue-600 mr-3"></i>
                                <span class="text-gray-700 hover:text-blue-600">Berita Terbaru</span>
                            </div>
                        </a>
                        <a href="<?php echo e(route('public.kontak')); ?>" class="block p-3 bg-gray-50 rounded-lg hover:bg-blue-50 transition-colors">
                            <div class="flex items-center">
        ...
        <section id="berita" class="news-section" style="padding: 6rem 2rem; background: white;">
            <div style="max-width: 1200px; margin: 0 auto;">
                ...
                <div class="news-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 2rem; padding: 0 1rem;">
                    <?php $__empty_1 = true; $__currentLoopData = $latestNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $berita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <article class="news-card fade-in" style="background: white; border-radius: 1rem; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.1); transition: all 0.3s ease; border-left: 4px solid #003f88;">
                        <?php if($berita->image): ?>
                        <div style="height: 200px; background-image: url('<?php echo e(asset('storage/' . $berita->image)); ?>'); background-size: cover; background-position: center;"></div>
                        <?php endif; ?>
                        <div style="padding: 2rem;">
                            <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 1rem;">
                                <span style="background: <?php echo e($berita->is_featured ? '#ef4444' : '#10b981'); ?>; color: white; padding: 0.25rem 0.75rem; border-radius: 1rem; font-size: 0.75rem; font-weight: 500;"><?php echo e($berita->is_featured ? 'UNGGULAN' : 'BERITA'); ?></span>
                                <span style="color: #666; font-size: 0.875rem;"><?php echo e($berita->published_at->diffForHumans()); ?></span>
                            </div>
                            <h3 style="font-size: 1.25rem; font-weight: 600; margin-bottom: 1rem; color: #333;"><?php echo e($berita->title); ?></h3>
                            <p style="color: #666; margin-bottom: 1.5rem;"><?php echo e(Str::limit($berita->excerpt, 120)); ?></p>
                            <div style="display: flex; justify-content: space-between; align-items: center;">
                                <a href="<?php echo e(route('public.berita.detail', $berita->slug)); ?>" style="color: #003f88; text-decoration: none; font-weight: 500;">Baca Selengkapnya →</a>
                ...
                <div style="margin-top: 3rem; text-align: center;">
                    <a href="<?php echo e(route('public.berita')); ?>" style="display: inline-block; padding: 1rem 2rem; background: #003f88; color: white; text-decoration: none; border-radius: 0.5rem; font-weight: 500; transition: all 0.3s ease;">Lihat Semua Berita</a>
                </div>
                <?php endif; ?>
            </div>
        </section>
        ...
        <section class="contact-section" style="padding: 6rem 2rem; background: #003f88; color: white;">
            <div style="max-width: 1200px; margin: 0 auto; text-align: center;">
                ...
                <a href="<?php echo e(route('login')); ?>" class="fade-in btn-primary" style="display: inline-block; padding: 1rem 2rem; background: white; color: #003f88; text-decoration: none; border-radius: 0.5rem; font-weight: 600; transition: all 0.3s ease;">Mulai Layanan Online</a>
            </div>
        </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="<?php echo e(route('welcome')); ?>" class="text-gray-300 hover:text-white transition-colors">Beranda</a></li>
