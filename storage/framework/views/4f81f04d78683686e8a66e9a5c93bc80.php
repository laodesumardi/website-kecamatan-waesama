            ...
            <div class="flex justify-between items-center py-4">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <div class="flex space-x-2">
                        ...
                        <a href="<?php echo e(route('public.kontak')); ?>" class="public-nav-item active"><i class="fas fa-phone mr-2"></i>Kontak</a>
                    </div>
                        ...
                        <form action="<?php echo e(route('public.kontak.store')); ?>" method="POST" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="nama_lengkap" value="<?php echo e(old('nama_lengkap')); ?>" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent <?php $__errorArgs = ['nama_lengkap'];
...
unset($__errorArgs, $__bag); ?>" placeholder="Masukkan nama lengkap">
                                ...
                                <div>
                                    ...
                                    <input type="email" name="email" value="<?php echo e(old('email')); ?>" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Masukkan email">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="tel" name="nomor_hp" value="<?php echo e(old('nomor_hp')); ?>" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent <?php $__errorArgs = ['nomor_hp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Masukkan nomor HP">
                                ...
                                <div>
                                    ...
                                    <select name="kategori" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent <?php $__errorArgs = ['kategori'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <option value="informasi" <?php echo e(old('kategori') == 'informasi' ? 'selected' : ''); ?>>Permintaan Informasi</option>
                                        <option value="keluhan" <?php echo e(old('kategori') == 'keluhan' ? 'selected' : ''); ?>>Keluhan</option>
                                        <option value="saran" <?php echo e(old('kategori') == 'saran' ? 'selected' : ''); ?>>Saran</option>
                                        <option value="layanan" <?php echo e(old('kategori') == 'layanan' ? 'selected' : ''); ?>>Pertanyaan Layanan</option>
                            ...
                            <div>
                                ...
                                <input type="text" name="subjek" value="<?php echo e(old('subjek')); ?>" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent <?php $__errorArgs = ['subjek'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Masukkan subjek pesan">
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Pesan *</label>
                                <textarea name="pesan" rows="5" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent resize-none <?php $__errorArgs = ['pesan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Tulis pesan Anda di sini..."><?php echo e(old('pesan')); ?></textarea>
                            </div>
...
</html><?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\public\kontak.blade.php ENDPATH**/ ?>