...
<?php $component->withAttributes([]); ?>
    ...
    <div class="mb-6 md:mb-8">
        <div class="flex flex-col sm:flex-row gap-4 justify-center sm:justify-start">
            <a href="<?php echo e(route('admin.citizens.create')); ?>" class="admin-action-btn flex items-center justify-center p-3 sm:p-4 rounded-xl border-2 border-dashed border-gray-300 hover:border-blue-300 hover:bg-blue-50 transition-all duration-300 group bg-white">
            ...
            <div class="relative">
                ...
                <div class="dropdown-menu dropdown-menu-right mt-2 bg-white/95 backdrop-blur-sm border border-gray-200/50 rounded-xl shadow-xl">
                    <a class="dropdown-item hover:bg-blue-50 transition-colors duration-200 rounded-lg mx-2 my-1" href="<?php echo e(route('admin.citizens.export', request()->query())); ?>" onclick="showExportLoading(this)">
                    ...
                    <a class="dropdown-item hover:bg-purple-50 transition-colors duration-200 rounded-lg mx-2 my-1" href="<?php echo e(route('admin.citizens.template')); ?>">
            ...
            <div class="admin-card admin-stat-card bg-white rounded-xl shadow-lg p-4 sm:p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                <div class="flex items-center">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-xl sm:text-2xl lg:text-3xl font-bold" style="color: #003566;"><?php echo e(number_format($stats['total'])); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="admin-card admin-stat-card bg-white rounded-xl shadow-lg p-4 sm:p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                <div class="flex items-center">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-xl sm:text-2xl lg:text-3xl font-bold" style="color: #16a34a;"><?php echo e(number_format($stats['male'])); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="admin-card admin-stat-card bg-white rounded-xl shadow-lg p-4 sm:p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                <div class="flex items-center">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-xl sm:text-2xl lg:text-3xl font-bold" style="color: #ec4899;"><?php echo e(number_format($stats['female'])); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="admin-card admin-stat-card bg-white rounded-xl shadow-lg p-4 sm:p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                <div class="flex items-center">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-xl sm:text-2xl lg:text-3xl font-bold" style="color: #10b981;"><?php echo e(number_format($stats['active'])); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="admin-card admin-stat-card bg-white rounded-xl shadow-lg p-4 sm:p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                <div class="flex items-center">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-xl sm:text-2xl lg:text-3xl font-bold" style="color: #ef4444;"><?php echo e(number_format($stats['inactive'])); ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="admin-card bg-white rounded-xl shadow-lg p-4 sm:p-6 mb-6 md:mb-8">
        ...
        <form method="GET" action="<?php echo e(route('admin.citizens.index')); ?>" class="space-y-6">
            <!-- Basic Search -->
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div>
                    <label for="search" class="block text-sm font-medium text-gray-700 mb-2">Pencarian Umum</label>
                    <div class="relative">
                        <input type="text" name="search" id="search" value="<?php echo e(request('search')); ?>" placeholder="Nama, NIK, Alamat, Telepon..." class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                ...
                <div>
                    ...
                    <select name="village_id" id="village_id" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        ...
                        <?php $__currentLoopData = $villages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $village): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($village->id); ?>" <?php echo e(request('village_id') == $village->id ? 'selected' : ''); ?>>
                ...
                <div class="flex items-end space-x-2">
                    ...
                    <a href="<?php echo e(route('admin.citizens.index')); ?>" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-3 rounded-lg transition-all duration-200" title="Reset Filter">
            ...
            <div class="border-t border-gray-200 pt-6">
                ...
                <div id="advancedFilters" class="<?php echo e(request()->hasAny(['gender', 'marital_status', 'religion', 'age_from', 'age_to', 'sort_by']) ? '' : 'hidden'); ?> space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <select name="marital_status" id="marital_status" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                <option value="">Semua</option>
                                <option value="Belum Kawin" <?php echo e(request('marital_status') == 'Belum Kawin' ? 'selected' : ''); ?>>Belum Kawin</option>
                                <option value="Kawin" <?php echo e(request('marital_status') == 'Kawin' ? 'selected' : ''); ?>>Kawin</option>
                                <option value="Cerai Hidup" <?php echo e(request('marital_status') == 'Cerai Hidup' ? 'selected' : ''); ?>>Cerai Hidup</option>
                                <option value="Cerai Mati" <?php echo e(request('marital_status') == 'Cerai Mati' ? 'selected' : ''); ?>>Cerai Mati</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="religion" id="religion" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                <option value="">Semua</option>
                                <option value="Islam" <?php echo e(request('religion') == 'Islam' ? 'selected' : ''); ?>>Islam</option>
                                <option value="Kristen" <?php echo e(request('religion') == 'Kristen' ? 'selected' : ''); ?>>Kristen</option>
                                <option value="Katolik" <?php echo e(request('religion') == 'Katolik' ? 'selected' : ''); ?>>Katolik</option>
                                <option value="Hindu" <?php echo e(request('religion') == 'Hindu' ? 'selected' : ''); ?>>Hindu</option>
                                <option value="Buddha" <?php echo e(request('religion') == 'Buddha' ? 'selected' : ''); ?>>Buddha</option>
                                <option value="Konghucu" <?php echo e(request('religion') == 'Konghucu' ? 'selected' : ''); ?>>Konghucu</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="flex space-x-3">
                                <input type="number" name="age_from" placeholder="Usia minimum" value="<?php echo e(request('age_from')); ?>" min="0" max="100" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                <span class="flex items-center text-gray-500">-</span>
                                <input type="number" name="age_to" placeholder="Usia maksimum" value="<?php echo e(request('age_to')); ?>" min="0" max="100" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex space-x-2">
                                <select name="sort_by" id="sort_by" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                    ...
                                    <option value="nik" <?php echo e(request('sort_by') == 'nik' ? 'selected' : ''); ?>>NIK</option>
                                    <option value="birth_date" <?php echo e(request('sort_by') == 'birth_date' ? 'selected' : ''); ?>>Tanggal Lahir</option>
                                    <option value="created_at" <?php echo e(request('sort_by') == 'created_at' ? 'selected' : ''); ?>>Tanggal Input</option>
                                </select>
                                <select name="sort_order" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                    <option value="asc" <?php echo e(request('sort_order') == 'asc' ? 'selected' : ''); ?>>A-Z</option>
                                    <option value="desc" <?php echo e(request('sort_order') == 'desc' ? 'selected' : ''); ?>>Z-A</option>
                                </select>
                            </div>
                        </div>
                    </div>
        ...
        <div class="p-4 sm:p-6 border-b border-gray-200">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">Menampilkan <?php echo e($citizens->count()); ?> dari <?php echo e($citizens->total()); ?> data</p>
                </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $citizens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $citizen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                            <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                                <input type="checkbox" class="citizen-checkbox rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" value="<?php echo e($citizen->id); ?>" onchange="updateBulkActions()">
                            </td>
                            <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900"><?php echo e($citizen->nik); ?></div>
                            </td>
                            <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <div class="text-sm font-medium text-gray-900"><?php echo e($citizen->name); ?></div>
                                        <div class="text-xs text-gray-500"><?php echo e($citizen->birth_place); ?>, <?php echo e($citizen->birth_date ? $citizen->birth_date->format('d/m/Y') : '-'); ?></div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <?php if($citizen->gender == 'L'): ?>
                            ...
                            <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900"><?php echo e($citizen->village->name); ?></div>
                            </td>
                            <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-4 sm:px-6 py-4 whitespace-nowrap text-center">
                                <div class="flex justify-center space-x-2">
                                    <a href="<?php echo e(route('admin.citizens.show', $citizen)); ?>" class="inline-flex items-center justify-center w-8 h-8 rounded-lg transition-all duration-200 hover:scale-110" style="background-color: #e6f3ff; color: #003566;" title="Lihat Detail">
                                        <i class="fas fa-eye text-xs"></i>
                                    </a>
                                    <a href="<?php echo e(route('admin.citizens.edit', $citizen)); ?>" class="inline-flex items-center justify-center w-8 h-8 rounded-lg transition-all duration-200 hover:scale-110" style="background-color: #fef3c7; color: #d97706;" title="Edit Data">
                                        <i class="fas fa-edit text-xs"></i>
                                    </a>
                                    <form action="<?php echo e(route('admin.citizens.destroy', $citizen)); ?>" method="POST" class="inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
                                        <?php echo csrf_field(); ?>
                        ...
                        <tr>
                            <td colspan="7" class="px-4 sm:px-6 py-12 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <a href="<?php echo e(route('admin.citizens.create')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors duration-200">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $citizens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $citizen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="p-4 border-b border-gray-200 last:border-b-0">
                    <div class="flex items-start justify-between mb-3">
                        <div class="flex items-center">
                            <input type="checkbox" class="citizen-checkbox rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 mr-3" value="<?php echo e($citizen->id); ?>" onchange="updateBulkActions()">
                            <div class="w-10 h-10 rounded-full flex items-center justify-center mr-3" style="background-color: #e6f3ff;">
                                <i class="fas fa-user text-sm" style="color: #003566;"></i>
                            </div>
                            <div>
                                <h4 class="font-medium text-gray-900"><?php echo e($citizen->name); ?></h4>
                                <p class="text-xs text-gray-500">NIK: <?php echo e($citizen->nik); ?></p>
                            </div>
                        </div>
                        <?php if($citizen->is_active): ?>
                    ...
                    <div class="grid grid-cols-2 gap-3 text-sm mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-900 text-sm mt-1"><?php echo e($citizen->village->name); ?></p>
                        </div>
                    </div>
                    
                    <div class="mb-4">
                        <span class="text-gray-500 text-xs">Tempat, Tanggal Lahir</span>
                        <p class="text-gray-900 text-sm mt-1"><?php echo e($citizen->birth_place); ?>, <?php echo e($citizen->birth_date ? $citizen->birth_date->format('d/m/Y') : '-'); ?></p>
                    </div>
                    
                    <div class="flex justify-end space-x-2 pt-3 border-t border-gray-100">
                        <a href="<?php echo e(route('admin.citizens.show', $citizen)); ?>" class="inline-flex items-center justify-center w-8 h-8 rounded-lg transition-all duration-200" style="background-color: #e6f3ff; color: #003566;" title="Lihat Detail">
                            <i class="fas fa-eye text-xs"></i>
                        </a>
                        <a href="<?php echo e(route('admin.citizens.edit', $citizen)); ?>" class="inline-flex items-center justify-center w-8 h-8 rounded-lg transition-all duration-200" style="background-color: #fef3c7; color: #d97706;" title="Edit Data">
                            <i class="fas fa-edit text-xs"></i>
                        </a>
                        <form action="<?php echo e(route('admin.citizens.destroy', $citizen)); ?>" method="POST" class="inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
                            <?php echo csrf_field(); ?>
        ...
        <div class="p-4 sm:p-6 border-t border-gray-200">
            <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                <div class="text-sm text-gray-600">
                    Menampilkan <?php echo e($citizens->firstItem() ?? 0); ?> - <?php echo e($citizens->lastItem() ?? 0); ?> dari <?php echo e($citizens->total()); ?> data
                </div>
                <div>
                    <?php echo e($citizens->appends(request()->query())->links()); ?>
    ...
    <div id="importModal" class="fixed inset-0 bg-black bg-opacity-50 overflow-y-auto h-full w-full hidden z-50 flex items-center justify-center">
        <div class="relative mx-auto p-0 border-0 shadow-2xl rounded-xl bg-white max-w-md w-full mx-4">
            ...
            <!-- Modal Body -->
            <div class="p-6">
                <form id="importForm" action="<?php echo e(route('admin.citizens.import')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-6 p-4 rounded-lg" style="background-color: #f8fafc; border: 1px solid #e2e8f0;">
                        <div class="flex items-center justify-between">
                            ...
                            <a href="<?php echo e(route('admin.citizens.template')); ?>" class="inline-flex items-center px-3 py-1 text-xs font-medium rounded-md transition-colors duration-200" style="background-color: #e6f3ff; color: #003566;" onmouseover="this.style.backgroundColor='#cce7ff'" onmouseout="this.style.backgroundColor='#e6f3ff'">
     ...
     <script>
         ...
         // Show advanced filters if any advanced filter is active
          document.addEventListener('DOMContentLoaded', function() {
              const hasAdvancedFilters = <?php echo e(request()->hasAny(['gender', 'marital_status', 'religion', 'age_from', 'age_to', 'sort_by']) ? 'true' : 'false'); ?>;
         ...
         function bulkExport() {
             ...
             form.method = 'POST';
             form.action = '<?php echo e(route("admin.citizens.bulk-export")); ?>';
         ...
         function performBulkAction(action, ids) {
             const form = document.createElement('form');
             form.method = 'POST';
             form.action = '<?php echo e(route("admin.citizens.bulk-action")); ?>';
...
<?php endif; ?><?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\admin\citizens\index.blade.php ENDPATH**/ ?>