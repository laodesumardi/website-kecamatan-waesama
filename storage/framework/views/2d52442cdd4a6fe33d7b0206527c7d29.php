    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="<?php echo e(route('admin.documents.update', $document)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="alert alert-info">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <strong>Nomor Dokumen:</strong> <?php echo e($document->document_number); ?><br>
                                            <strong>Template:</strong> <?php echo e(str_replace('_', ' ', ucwords($document->template_name, '_'))); ?><br>
                                        ...
                                        <div class="col-md-6">
                                            <strong>Dibuat:</strong> <?php echo e($document->created_at->format('d/m/Y H:i')); ?><br>
                                            <strong>Download:</strong> <?php echo e(number_format($document->download_count)); ?> kali<br>
                                            <strong>Ukuran:</strong> <?php echo e($document->formatted_file_size); ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-control-plaintext border rounded p-2 bg-light">
                                        <a href="<?php echo e(route('admin.service-requests.show', $document->serviceRequest)); ?>" class="text-decoration-none">
                                            <?php echo e($document->serviceRequest->request_number); ?> - <?php echo e($document->serviceRequest->citizen->name); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('valid_until', $document->valid_until?->format('Y-m-d'))); ?>" min="<?php echo e(date('Y-m-d')); ?>">
...
unset($__errorArgs, $__bag); ?>" rows="3" placeholder="Catatan tambahan untuk dokumen..."><?php echo e(old('notes', $document->notes)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="<?php echo e(route('admin.documents.show', $document)); ?>" class="btn btn-secondary">
...
$(document).ready(function() {
    ...
    const currentDocument = <?php echo json_encode($document, 15, 512) ?>;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\admin\documents\edit.blade.php ENDPATH**/ ?>