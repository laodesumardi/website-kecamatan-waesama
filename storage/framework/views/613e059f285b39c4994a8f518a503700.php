...
<?php $component->withAttributes([]); ?>
    ...
    <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-all duration-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-900 mt-2"><?php echo e($serviceRequests->total()); ?></p>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-all duration-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold mt-2" style="color: #d97706;"><?php echo e($serviceRequests->where('status', 'pending')->count()); ?></p>
                        <div class="flex items-center mt-2">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-all duration-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold mt-2" style="color: #2563eb;"><?php echo e($serviceRequests->where('status', 'processing')->count()); ?></p>
                        <div class="flex items-center mt-2">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-all duration-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold mt-2" style="color: #16a34a;"><?php echo e($serviceRequests->where('status', 'completed')->count()); ?></p>
                        <div class="flex items-center mt-2">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-all duration-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <a href="<?php echo e(route('admin.service-requests.create')); ?>" class="inline-flex items-center px-4 py-2 text-sm font-medium rounded-lg transition-colors duration-200" style="background-color: #003566; color: white;" onmouseover="this.style.backgroundColor='#002347'" onmouseout="this.style.backgroundColor='#003566'">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-all duration-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="text-2xl font-bold" style="color: #003566;"><?php echo e($serviceRequests->where('created_at', '>=', today())->count()); ?></div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-6">
            <div class="p-4 sm:p-6">
                <form method="GET" action="<?php echo e(route('admin.service-requests.index')); ?>" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <select name="priority" id="priority" class="block w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm transition-colors duration-200">
                                ...
                                <option value="medium" <?php echo e(request('priority') == 'medium' ? 'selected' : ''); ?>>Sedang</option>
                                <option value="high" <?php echo e(request('priority') == 'high' ? 'selected' : ''); ?>>Tinggi</option>
                                <option value="urgent" <?php echo e(request('priority') == 'urgent' ? 'selected' : ''); ?>>Mendesak</option>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <div>
                                ...
                                <select name="service_type" id="service_type" class="block w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm transition-colors duration-200">
                                    ...
                                    <option value="surat_keterangan_domisili" <?php echo e(request('service_type') == 'surat_keterangan_domisili' ? 'selected' : ''); ?>>Surat Keterangan Domisili</option>
                                    <option value="surat_keterangan_usaha" <?php echo e(request('service_type') == 'surat_keterangan_usaha' ? 'selected' : ''); ?>>Surat Keterangan Usaha</option>
                                    <option value="surat_keterangan_tidak_mampu" <?php echo e(request('service_type') == 'surat_keterangan_tidak_mampu' ? 'selected' : ''); ?>>Surat Keterangan Tidak Mampu</option>
                                    <option value="surat_pengantar_nikah" <?php echo e(request('service_type') == 'surat_pengantar_nikah' ? 'selected' : ''); ?>>Surat Pengantar Nikah</option>
                                    <option value="surat_keterangan_kelahiran" <?php echo e(request('service_type') == 'surat_keterangan_kelahiran' ? 'selected' : ''); ?>>Surat Keterangan Kelahiran</option>
                                    <option value="surat_keterangan_kematian" <?php echo e(request('service_type') == 'surat_keterangan_kematian' ? 'selected' : ''); ?>>Surat Keterangan Kematian</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="sort_by" id="sort_by" class="block w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm transition-colors duration-200">
                                    ...
                                    <option value="request_number" <?php echo e(request('sort_by') == 'request_number' ? 'selected' : ''); ?>>Nomor Permintaan</option>
                                    <option value="applicant_name" <?php echo e(request('sort_by') == 'applicant_name' ? 'selected' : ''); ?>>Nama Pemohon</option>
                                    <option value="priority" <?php echo e(request('sort_by') == 'priority' ? 'selected' : ''); ?>>Prioritas</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 pt-4 border-t border-gray-200">
                        ...
                        <a href="<?php echo e(route('admin.service-requests.index')); ?>" class="inline-flex items-center justify-center px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 text-sm font-medium rounded-lg transition-colors duration-200">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $serviceRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 transition-colors duration-200">
                                <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($request->request_number); ?></div>
                                    <div class="text-xs text-gray-500"><?php echo e($request->created_at->format('d/m/Y H:i')); ?></div>
                                </td>
                                <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <div class="text-sm font-medium text-gray-900"><?php echo e($request->applicant_name); ?></div>
                                            <div class="text-xs text-gray-500">NIK: <?php echo e($request->applicant_nik); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900"><?php echo e($request->service_type_display); ?></div>
                                    <?php if($request->priority): ?>
                                        ...
                                        ?>
                                        <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium mt-1" style="background-color: <?php echo e($priorityConf['bg']); ?>; color: <?php echo e($priorityConf['color']); ?>;">
                                            <?php echo e($priorityConf['label']); ?>
                                ...
                                <td class="px-4 sm:px-6 py-4 whitespace-nowrap text-center">
                                    <div class="flex justify-center space-x-2">
                                        <a href="<?php echo e(route('admin.service-requests.show', $request)); ?>" class="inline-flex items-center justify-center w-8 h-8 rounded-lg transition-all duration-200 hover:scale-110" style="background-color: #e6f3ff; color: #003566;" title="Lihat Detail">
                                            <i class="fas fa-eye text-xs"></i>
                                        </a>
                                        <a href="<?php echo e(route('admin.service-requests.edit', $request)); ?>" class="inline-flex items-center justify-center w-8 h-8 rounded-lg transition-all duration-200 hover:scale-110" style="background-color: #fef3c7; color: #d97706;" title="Edit Data">
                                            <i class="fas fa-edit text-xs"></i>
                                        </a>
                                        <form action="<?php echo e(route('admin.service-requests.destroy', $request)); ?>" method="POST" class="inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
                                            <?php echo csrf_field(); ?>
                            ...
                            <tr>
                                <td colspan="5" class="px-4 sm:px-6 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <a href="<?php echo e(route('admin.service-requests.create')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors duration-200">
                                            <i class="fas fa-plus mr-2"></i>
                    ...
                    <div class="p-4 border-b border-gray-200 last:border-b-0">
                        <div class="flex items-start justify-between mb-3">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <h4 class="font-medium text-gray-900"><?php echo e($request->request_number); ?></h4>
                                    <p class="text-xs text-gray-500"><?php echo e($request->applicant_name); ?></p>
                                </div>
                            </div>
                            <?php if($request->status == 'pending'): ?>
                        ...
                        <div class="grid grid-cols-2 gap-3 text-sm mb-4">
                            <div>
                                ...
                                <p class="text-gray-900 text-sm mt-1"><?php echo e($request->service_type_display); ?></p>
                            </div>
                            <div>
                                <span class="text-gray-500 text-xs">NIK Pemohon</span>
                                <p class="text-gray-900 text-sm mt-1"><?php echo e($request->applicant_nik); ?></p>
                            </div>
                        </div>
                        ...
                        <?php if($request->purpose): ?>
                            <div class="mb-4">
                                ...
                                <p class="text-gray-900 text-sm mt-1"><?php echo e($request->purpose); ?></p>
                            </div>
                        <?php endif; ?>
                        
                        <div class="mb-4">
                            <span class="text-gray-500 text-xs">Tanggal Dibuat</span>
                            <p class="text-gray-900 text-sm mt-1"><?php echo e($request->created_at->format('d/m/Y H:i')); ?></p>
                        </div>
                        
                        <div class="flex justify-end space-x-2 pt-3 border-t border-gray-100">
                            <a href="<?php echo e(route('admin.service-requests.show', $request)); ?>" class="inline-flex items-center justify-center w-8 h-8 rounded-lg transition-all duration-200" style="background-color: #e6f3ff; color: #003566;" title="Lihat Detail">
                                <i class="fas fa-eye text-xs"></i>
                            </a>
                            <a href="<?php echo e(route('admin.service-requests.edit', $request)); ?>" class="inline-flex items-center justify-center w-8 h-8 rounded-lg transition-all duration-200" style="background-color: #fef3c7; color: #d97706;" title="Edit Data">
                                <i class="fas fa-edit text-xs"></i>
                            </a>
                            <form action="<?php echo e(route('admin.service-requests.destroy', $request)); ?>" method="POST" class="inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
                                <?php echo csrf_field(); ?>
            ...
            <div class="p-4 sm:p-6 border-t border-gray-200">
                <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                    <div class="text-sm text-gray-600">
                        Menampilkan <?php echo e($serviceRequests->firstItem() ?? 0); ?> - <?php echo e($serviceRequests->lastItem() ?? 0); ?> dari <?php echo e($serviceRequests->total()); ?> data
                    </div>
                    <div>
                        <?php echo e($serviceRequests->appends(request()->query())->links()); ?>
    ...
    <script>
        ...
        <?php if(!request()->hasAny(['search', 'status', 'service_type'])): ?>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const hasAdvancedFilters = <?php echo e(request()->hasAny(['service_type', 'date_from', 'date_to', 'sort_by']) ? 'true' : 'false'); ?>;
...
<?php endif; ?><?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\admin\service-requests\index.blade.php ENDPATH**/ ?>