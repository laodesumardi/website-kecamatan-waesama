...
<div class="space-y-6">
        ...
        <div class="bg-white rounded-xl p-6 card-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-800 mt-1"><?php echo e(number_format($stats['total'])); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl p-6 card-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-800 mt-1"><?php echo e(number_format($stats['pending'])); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl p-6 card-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-800 mt-1"><?php echo e(number_format($stats['diproses'])); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl p-6 card-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-800 mt-1"><?php echo e(number_format($stats['selesai'])); ?></p>
                </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border p-6 mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <a href="<?php echo e(route('warga.surat.create')); ?>" class="flex items-center p-4 bg-primary-50 hover:bg-primary-100 rounded-lg transition-colors duration-200">
            ...
            <a href="<?php echo e(route('warga.surat.list')); ?>" class="flex items-center p-4 bg-green-50 hover:bg-green-100 rounded-lg transition-colors duration-200">
                <div class="flex-shrink-0">
    ...
    <div class="bg-white rounded-lg shadow-sm border p-6">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="<?php echo e(route('warga.surat.list')); ?>" class="text-sm text-primary-600 hover:text-primary-800">Lihat Semua</a>
        </div>
        
        <div class="space-y-4">
            <?php $__empty_1 = true; $__currentLoopData = $recentSurat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center justify-between">
                            <p class="text-sm font-medium text-gray-900 truncate">
                                Surat <?php echo e($item->jenis_surat); ?> - <?php echo e($item->nomor_surat); ?>
                        ...
                        <p class="text-sm text-gray-500 truncate"><?php echo e(Str::limit($item->keperluan, 60)); ?></p>
                        <p class="text-xs text-gray-400 mt-1"><?php echo e($item->created_at->diffForHumans()); ?></p>
                    </div>
                    <div class="flex-shrink-0">
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="text-center py-8">
                    ...
                    <a href="<?php echo e(route('warga.surat.create')); ?>" class="text-sm text-blue-600 hover:text-blue-800 mt-2 inline-block">
...
<?php echo $__env->make('layouts.warga', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\warga\surat\index.blade.php ENDPATH**/ ?>