            ...
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                    ...
                    <div class="lg:col-span-2">
                        <form method="GET" action="<?php echo e(route('admin.documents.index')); ?>" class="flex">
                            <?php if(request('template')): ?>
                                <input type="hidden" name="template" value="<?php echo e(request('template')); ?>">
                            <?php endif; ?>
                    ...
                    <div>
                        <form method="GET" action="<?php echo e(route('admin.documents.index')); ?>">
                            ...
                            <select name="template" 
                                ...
                                <option value="surat_keterangan_domisili" <?php echo e(request('template') == 'surat_keterangan_domisili' ? 'selected' : ''); ?>>Surat Keterangan Domisili</option>
                                <option value="surat_keterangan_usaha" <?php echo e(request('template') == 'surat_keterangan_usaha' ? 'selected' : ''); ?>>Surat Keterangan Usaha</option>
                                <option value="surat_keterangan_tidak_mampu" <?php echo e(request('template') == 'surat_keterangan_tidak_mampu' ? 'selected' : ''); ?>>Surat Keterangan Tidak Mampu</option>
                                <option value="surat_pengantar_nikah" <?php echo e(request('template') == 'surat_pengantar_nikah' ? 'selected' : ''); ?>>Surat Pengantar Nikah</option>
                                <option value="surat_keterangan_kelahiran" <?php echo e(request('template') == 'surat_keterangan_kelahiran' ? 'selected' : ''); ?>>Surat Keterangan Kelahiran</option>
                                <option value="surat_keterangan_kematian" <?php echo e(request('template') == 'surat_keterangan_kematian' ? 'selected' : ''); ?>>Surat Keterangan Kematian</option>
                            </select>
                        </form>
                    </div>
                ...
                <!-- Reset Button -->
                <?php if(request()->hasAny(['search', 'template', 'status'])): ?>
    ...
    <div class="admin-card admin-stat-card bg-white rounded-xl shadow-md hover:shadow-lg border border-gray-100 p-4 sm:p-6 transition-all duration-300 hover:scale-105">
        <div class="flex items-center justify-between">
            <div class="flex-1">
                ...
                <p class="text-2xl sm:text-3xl font-bold" style="color: #003566;"><?php echo e($documents->total() ?? 0); ?></p>
    ...
    <div class="admin-card admin-stat-card bg-white rounded-xl shadow-md hover:shadow-lg border border-gray-100 p-4 sm:p-6 transition-all duration-300 hover:scale-105">
        <div class="flex items-center justify-between">
            <div class="flex-1">
                ...
                <p class="text-2xl sm:text-3xl font-bold" style="color: #003566;"><?php echo e($documents->where('is_active', true)->count() ?? 0); ?></p>
    ...
    <div class="admin-card admin-stat-card bg-white rounded-xl shadow-md hover:shadow-lg border border-gray-100 p-4 sm:p-6 transition-all duration-300 hover:scale-105">
        <div class="flex items-center justify-between">
            <div class="flex-1">
                ...
                <p class="text-2xl sm:text-3xl font-bold" style="color: #003566;"><?php echo e($documents->where('created_at', '>=', now()->startOfMonth())->count() ?? 0); ?></p>
                <p class="text-xs sm:text-sm text-orange-600 mt-1 flex items-center">
                    <i class="fas fa-calendar mr-1"></i> <?php echo e(now()->format('F Y')); ?>
    ...
    <div class="admin-card admin-stat-card bg-white rounded-xl shadow-md hover:shadow-lg border border-gray-100 p-4 sm:p-6 transition-all duration-300 hover:scale-105">
        <div class="flex items-center justify-between">
            <div class="flex-1">
                ...
                <p class="text-2xl sm:text-3xl font-bold" style="color: #003566;"><?php echo e($documents->sum('download_count') ?? 0); ?></p>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-6 md:mb-8">
    ...
    <div class="admin-card bg-white rounded-xl shadow-md hover:shadow-lg border border-gray-100 p-4 sm:p-6 transition-all duration-300">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            <a href="<?php echo e(route('admin.documents.create')); ?>" class="admin-action-btn flex items-center p-3 sm:p-4 rounded-xl border-2 border-dashed border-gray-300 hover:border-blue-300 hover:bg-blue-50 transition-all duration-300 group">
            ...
            <a href="<?php echo e(route('admin.documents.index', ['status' => 'active'])); ?>" class="admin-action-btn flex items-center p-3 sm:p-4 rounded-xl border-2 border-dashed border-gray-300 hover:border-green-300 hover:bg-green-50 transition-all duration-300 group">
            ...
            <a href="<?php echo e(route('admin.documents.index')); ?>" class="admin-action-btn flex items-center p-3 sm:p-4 rounded-xl border-2 border-dashed border-gray-300 hover:border-purple-300 hover:bg-purple-50 transition-all duration-300 group">
    ...
    <div class="admin-card bg-white rounded-xl shadow-md hover:shadow-lg border border-gray-100 p-4 sm:p-6 transition-all duration-300">
        ...
        <div class="space-y-3 sm:space-y-4">
            ...
            <div class="flex items-start space-x-3 p-2 sm:p-3 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                ...
                <div class="flex-1 min-w-0">
                    <p class="text-xs sm:text-sm font-medium text-gray-900 truncate">Dokumen <?php echo e($doc->document_number); ?></p>
                    <p class="text-xs text-gray-500 mt-1"><?php echo e($doc->created_at->diffForHumans()); ?></p>
                </div>
            </div>
        ...
        <div class="mt-4 pt-4 border-t border-gray-200">
            <a href="<?php echo e(route('admin.documents.index')); ?>" class="text-sm font-medium hover:underline" style="color: #003566;">
                ...
                <div class="block lg:hidden space-y-4">
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                        <div class="flex justify-between items-start mb-3">
                            <div class="flex-1">
                                <h3 class="font-semibold text-gray-900"><?php echo e($document->document_number); ?></h3>
                                <p class="text-sm text-gray-600 mt-1">
                                    <?php echo e(str_replace('_', ' ', ucwords($document->template_name, '_'))); ?>
                        ...
                        <?php if($document->serviceRequest && $document->serviceRequest->citizen): ?>
                        <div class="mb-3">
                            <p class="text-sm font-medium text-gray-900"><?php echo e($document->serviceRequest->citizen->name); ?></p>
                            <p class="text-xs text-gray-500">NIK: <?php echo e($document->serviceRequest->citizen->nik); ?></p>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="grid grid-cols-2 gap-4 text-sm mb-3">
                            <div>
                                ...
                                <span class="font-medium"><?php echo e($document->formatted_file_size ?? 'N/A'); ?></span>
                            </div>
                            <div>
                                <span class="text-gray-500">Download:</span>
                                <span class="font-medium"><?php echo e($document->download_count ?? 0); ?>x</span>
                            </div>
                        </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    <?php echo e($documents->firstItem() + $index); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div>
                                        <div class="text-sm font-medium text-gray-900"><?php echo e($document->document_number); ?></div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    ...
                                    <a href="<?php echo e(route('admin.service-requests.show', $document->serviceRequest)); ?>" 
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <?php if($document->serviceRequest && $document->serviceRequest->citizen): ?>
                                    <div>
                                        <div class="text-sm font-medium text-gray-900"><?php echo e($document->serviceRequest->citizen->name); ?></div>
                                        <div class="text-sm text-gray-500">NIK: <?php echo e($document->serviceRequest->citizen->nik); ?></div>
                                    </div>
                                    <?php else: ?>
                                    <span class="text-gray-400">-</span>
                                    <?php endif; ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex flex-col space-y-1">
                                        ...
                                        <?php endif; ?>
                                        <?php if($document->valid_until && $document->valid_until < now()): ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    <div class="space-y-1">
                                        <div><?php echo e($document->formatted_file_size ?? 'N/A'); ?></div>
                                        <div class="text-xs text-gray-500">
                                            <i class="fas fa-download mr-1"></i><?php echo e($document->download_count ?? 0); ?>x
                                        </div>
                                        <div class="text-xs text-gray-500"><?php echo e($document->created_at->format('d/m/Y')); ?></div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <a href="<?php echo e(route('admin.documents.preview', $document)); ?>" 
                                        ...
                                        <?php if($document->is_active): ?>
                                        <form action="<?php echo e(route('admin.documents.deactivate', $document)); ?>" method="POST" class="inline">
                                            <?php echo csrf_field(); ?>
                                        ...
                                        <?php else: ?>
                                        <form action="<?php echo e(route('admin.documents.activate', $document)); ?>" method="POST" class="inline">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PATCH'); ?>
                                        ...
                                        <?php endif; ?>
                                        <form action="<?php echo e(route('admin.documents.destroy', $document)); ?>" method="POST" class="inline">
                                            <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\admin\documents\index.blade.php ENDPATH**/ ?>