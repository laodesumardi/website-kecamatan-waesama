    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="<?php echo e(route('admin.documents.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="service_request_id" id="service_request_id" class="form-select <?php $__errorArgs = ['service_request_id'];
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <option value="<?php echo e($request->id); ?>" <?php echo e((old('service_request_id') ?? request('service_request_id')) == $request->id ? 'selected' : ''); ?>>
                                            <?php echo e($request->request_number); ?> - <?php echo e($request->citizen->name); ?> (<?php echo e(str_replace('_', ' ', ucwords($request->service_type, '_'))); ?>)
                                        </option>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="template_name" id="template_name" class="form-select <?php $__errorArgs = ['template_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                                        ...
                                        <option value="surat_keterangan_domisili" <?php echo e(old('template_name') == 'surat_keterangan_domisili' ? 'selected' : ''); ?>>Surat Keterangan Domisili</option>
                                        <option value="surat_keterangan_usaha" <?php echo e(old('template_name') == 'surat_keterangan_usaha' ? 'selected' : ''); ?>>Surat Keterangan Usaha</option>
                                        <option value="surat_keterangan_tidak_mampu" <?php echo e(old('template_name') == 'surat_keterangan_tidak_mampu' ? 'selected' : ''); ?>>Surat Keterangan Tidak Mampu</option>
                                        <option value="surat_pengantar_nikah" <?php echo e(old('template_name') == 'surat_pengantar_nikah' ? 'selected' : ''); ?>>Surat Pengantar Nikah</option>
                                        <option value="surat_keterangan_kelahiran" <?php echo e(old('template_name') == 'surat_keterangan_kelahiran' ? 'selected' : ''); ?>>Surat Keterangan Kelahiran</option>
                                        <option value="surat_keterangan_kematian" <?php echo e(old('template_name') == 'surat_keterangan_kematian' ? 'selected' : ''); ?>>Surat Keterangan Kematian</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('valid_until')); ?>" min="<?php echo e(date('Y-m-d')); ?>">
...
unset($__errorArgs, $__bag); ?>" rows="3" placeholder="Catatan tambahan untuk dokumen..."><?php echo e(old('notes')); ?></textarea>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\admin\documents\create.blade.php ENDPATH**/ ?>