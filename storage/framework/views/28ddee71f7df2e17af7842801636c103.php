...
<div class="bg-gradient-to-r from-blue-600 to-blue-800 rounded-xl shadow-lg p-6 mb-6">
    ...
    <p class="text-blue-100">Edit data antrian <?php echo e($antrian->nomor_antrian); ?></p>
</div>
<div class="max-w-4xl mx-auto">
    <!-- Form Card -->
    <div class="bg-white rounded-xl card-shadow p-6">
                    <form action="<?php echo e(route('admin.antrian.update', $antrian)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="text" id="nomor_antrian" value="<?php echo e($antrian->nomor_antrian); ?>" disabled class="w-full px-3 py-2 border border-gray-300 rounded-xl bg-gray-100 text-gray-600">
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <?php $__currentLoopData = $jenisLayananOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($jenis); ?>" <?php echo e((old('jenis_layanan', $antrian->jenis_layanan) == $jenis) ? 'selected' : ''); ?>><?php echo e($jenis); ?></option>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <select name="status" id="status" required class="w-full px-3 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                        <?php $__currentLoopData = $statusOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($status); ?>" <?php echo e((old('status', $antrian->status) == $status) ? 'selected' : ''); ?>><?php echo e($status); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                                <div>
                                    ...
                                    <input type="number" name="estimasi_waktu" id="estimasi_waktu" value="<?php echo e(old('estimasi_waktu', $antrian->estimasi_waktu)); ?>" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['estimasi_waktu'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <?php $__currentLoopData = $pegawaiUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pegawai): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($pegawai->id); ?>" <?php echo e((old('dilayani_oleh', $antrian->dilayani_oleh) == $pegawai->id) ? 'selected' : ''); ?>><?php echo e($pegawai->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="nama_pengunjung" id="nama_pengunjung" value="<?php echo e(old('nama_pengunjung', $antrian->nama_pengunjung)); ?>" required class="w-full px-3 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['nama_pengunjung'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="nik_pengunjung" id="nik_pengunjung" value="<?php echo e(old('nik_pengunjung', $antrian->nik_pengunjung)); ?>" maxlength="16" class="w-full px-3 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['nik_pengunjung'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="phone_pengunjung" id="phone_pengunjung" value="<?php echo e(old('phone_pengunjung', $antrian->phone_pengunjung)); ?>" required class="w-full px-3 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['phone_pengunjung'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="date" name="tanggal_kunjungan" id="tanggal_kunjungan" value="<?php echo e(old('tanggal_kunjungan', $antrian->tanggal_kunjungan->format('Y-m-d'))); ?>" required class="w-full px-3 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['tanggal_kunjungan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="time" name="jam_kunjungan" id="jam_kunjungan" value="<?php echo e(old('jam_kunjungan', $antrian->jam_kunjungan->format('H:i'))); ?>" required class="w-full px-3 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['jam_kunjungan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Jelaskan keperluan kunjungan..."><?php echo e(old('keperluan', $antrian->keperluan)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" placeholder="Catatan tambahan..."><?php echo e(old('catatan', $antrian->catatan)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="bg-gray-50 rounded-lg p-4">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-gray-900"><?php echo e($antrian->waktu_mulai_layanan->format('d/m/Y H:i')); ?></span>
                                    </div>
                                    <?php endif; ?>
                                    <?php if($antrian->waktu_selesai_layanan): ?>
                                    <div>
                                        <span class="font-medium text-gray-700">Selesai Layanan:</span>
                                        <span class="text-gray-900"><?php echo e($antrian->waktu_selesai_layanan->format('d/m/Y H:i')); ?></span>
                                    </div>
                                    <?php endif; ?>
                                </div>
                        ...
                        <div class="flex justify-end space-x-4 pt-6 border-t border-gray-200">
                            <a href="<?php echo e(route('admin.antrian.show', $antrian)); ?>" class="px-6 py-2 border border-gray-300 text-gray-700 rounded-xl hover:bg-gray-50 transition-colors">
...
document.getElementById('status').addEventListener('change', function() {
    const currentStatus = '<?php echo e($antrian->status); ?>';
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\admin\antrian\edit.blade.php ENDPATH**/ ?>