...
<div class="mb-6 md:mb-8">
    <div class="admin-card admin-welcome-card rounded-xl shadow-lg p-4 sm:p-6 lg:p-8 bg-[#001d3d]">
        <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div class="text-white text-center sm:text-left">
                <h2 class="text-xl sm:text-2xl lg:text-3xl font-bold mb-2">Kelola Gallery, <?php echo e(Auth::user()->name); ?>!</h2>
        ...
        <div class="admin-card admin-stat-card bg-white rounded-xl shadow-md hover:shadow-lg border border-gray-100 p-4 sm:p-6 transition-all duration-300 hover:scale-105">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    ...
                    <p class="text-2xl sm:text-3xl font-bold" style="color: #003566;"><?php echo e($galleries->total()); ?></p>
        ...
        <div class="admin-card admin-stat-card bg-white rounded-xl shadow-md hover:shadow-lg border border-gray-100 p-4 sm:p-6 transition-all duration-300 hover:scale-105">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    ...
                    <p class="text-2xl sm:text-3xl font-bold" style="color: #003566;"><?php echo e($galleries->where('status', 'active')->count()); ?></p>
        ...
        <div class="admin-card admin-stat-card bg-white rounded-xl shadow-md hover:shadow-lg border border-gray-100 p-4 sm:p-6 transition-all duration-300 hover:scale-105">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    ...
                    <p class="text-2xl sm:text-3xl font-bold" style="color: #003566;"><?php echo e($galleries->where('status', 'inactive')->count()); ?></p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-6 md:mb-8">
        ...
        <div class="admin-card bg-white rounded-xl shadow-md hover:shadow-lg border border-gray-100 p-4 sm:p-6 transition-all duration-300">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                <a href="<?php echo e(route('admin.galleries.create')); ?>" class="admin-action-btn flex items-center p-3 sm:p-4 rounded-xl border-2 border-dashed border-gray-300 hover:border-blue-300 hover:bg-blue-50 transition-all duration-300 group">
        ...
        <div class="admin-card bg-white rounded-xl shadow-md hover:shadow-lg border border-gray-100 p-4 sm:p-6 transition-all duration-300">
            ...
            <div class="mt-4 pt-4 border-t border-gray-200">
                <a href="<?php echo e(route('admin.activity-logs')); ?>" class="text-sm font-medium hover:underline" style="color: #003566;">
    ...
    <div class="admin-card bg-white rounded-xl shadow-md hover:shadow-lg border border-gray-100 p-4 sm:p-6 transition-all duration-300">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="<?php echo e(route('admin.galleries.create')); ?>" 
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <?php $__currentLoopData = $galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="text-sm font-medium text-gray-900"><?php echo e($gallery->title); ?></div>
                                        </td>
                                        <td class="px-6 py-4">
                                            <div class="text-sm text-gray-500">
                                                <?php echo e(Str::limit($gallery->description, 50)); ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <?php echo e($gallery->created_at->format('M d, Y')); ?>

                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex space-x-2">
                                                <a href="<?php echo e(route('admin.galleries.show', $gallery)); ?>" 
...
<?php endif; ?><?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\admin\galleries\index.blade.php ENDPATH**/ ?>