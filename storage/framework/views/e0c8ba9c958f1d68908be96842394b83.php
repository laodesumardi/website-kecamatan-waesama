            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div class="text-center">
                    ...
                    <span class="inline-block bg-primary-100 text-primary-800 text-xs font-medium px-2.5 py-0.5 rounded-full">
                        <?php echo e($user->role->name ?? 'Warga'); ?>
                ...
                <div class="mt-6 space-y-3">
                    <div class="flex items-center text-sm text-gray-600">
                        ...
                        <span>NIK: <?php echo e($user->nik ?? '-'); ?></span>
                    </div>
                    <div class="flex items-center text-sm text-gray-600">
                        <i class="fas fa-calendar-alt w-4 mr-3"></i>
                        <span>Bergabung: <?php echo e($user->created_at->format('d M Y')); ?></span>
                    </div>
                    <div class="flex items-center text-sm text-gray-600">
                        <i class="fas fa-clock w-4 mr-3"></i>
                        <span>Terakhir login: <?php echo e($user->updated_at->format('d M Y H:i')); ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                ...
                <div id="profile-tab" class="tab-content p-6">
                    <form action="<?php echo e(route('warga.profil.update')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="alamat" 
                                          name="alamat" 
                                          rows="3"
                                          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"><?php echo e(old('alamat', $user->address)); ?></textarea>
                            </div>
                        </div>
                ...
                <div id="password-tab" class="tab-content p-6 hidden">
                    <form action="<?php echo e(route('warga.profil.password')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\warga\profil.blade.php ENDPATH**/ ?>