        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['surat_diproses'] ?? 0); ?></p>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['surat_selesai'] ?? 0); ?></p>
                    <p class="text-xs text-gray-500 mt-1">Hari ini</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['surat_pending'] ?? 0); ?></p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                ...
                <div class="flex items-center justify-between p-3 bg-yellow-50 rounded-lg">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600"><?php echo e($stats['surat_pending'] ?? 0); ?> surat menunggu</p>
                        </div>
                    </div>
                ...
                <div class="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600"><?php echo e($stats['surat_diproses'] ?? 0); ?> surat dalam proses</p>
                        </div>
                    </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div class="grid grid-cols-2 gap-3">
                ...
                <a href="<?php echo e(route('pegawai.penduduk.index')); ?>" class="p-4 rounded-lg border-2 border-dashed border-gray-200 hover:border-purple-300 hover:bg-purple-50 transition-all duration-200 group">
                    <div class="text-center">
                ...
                <a href="<?php echo e(route('pegawai.laporan.index')); ?>" class="p-4 rounded-lg border-2 border-dashed border-gray-200 hover:border-orange-300 hover:bg-orange-50 transition-all duration-200 group">
                    <div class="text-center">
            ...
            <div class="space-y-4">
                <div>
                    <div class="flex justify-between items-center mb-1">
                        ...
                        <span class="text-sm text-gray-500"><?php echo e($stats['progress_surat'] ?? 75); ?>%</span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-2">
                        <div class="bg-blue-600 h-2 rounded-full" style="width: <?php echo e($stats['progress_surat'] ?? 75); ?>%"></div>
                    </div>
                </div>
                ...
                <div>
                    <div class="flex justify-between items-center mb-1">
                        ...
                        <span class="text-sm text-gray-500"><?php echo e($stats['kepuasan'] ?? 92); ?>%</span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-2">
                        <div class="bg-green-600 h-2 rounded-full" style="width: <?php echo e($stats['kepuasan'] ?? 92); ?>%"></div>
                    </div>
                </div>
                ...
                <div>
                    <div class="flex justify-between items-center mb-1">
                        ...
                        <span class="text-sm text-gray-500"><?php echo e($stats['efisiensi'] ?? 88); ?>%</span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-2">
                        <div class="bg-yellow-600 h-2 rounded-full" style="width: <?php echo e($stats['efisiensi'] ?? 88); ?>%"></div>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\pegawai\surat\index.blade.php ENDPATH**/ ?>