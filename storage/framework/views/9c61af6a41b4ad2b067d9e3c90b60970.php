...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-xl card-shadow p-6">
                        ...
                        <div class="space-y-3">
                            <?php if($antrian->status === 'Menunggu'): ?>
                                <form action="<?php echo e(route('admin.antrian.call', $antrian)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                ...
                                <form action="<?php echo e(route('admin.antrian.serve', $antrian)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                ...
                                <form action="<?php echo e(route('admin.antrian.cancel', $antrian)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                            ...
                            <?php elseif($antrian->status === 'Dilayani'): ?>
                                <form action="<?php echo e(route('admin.antrian.complete', $antrian)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                    ...
                    <div class="bg-white rounded-xl card-shadow p-6">
                        ...
                        <div class="space-y-3">
                            <a href="<?php echo e(route('admin.antrian.edit', $antrian)); ?>" class="w-full px-4 py-2 bg-green-600 text-white rounded-xl hover:bg-green-700 transition-colors flex items-center justify-center">
                                <i class="fas fa-edit mr-2"></i>Edit Antrian
                            </a>
                            <a href="<?php echo e(route('admin.antrian.index')); ?>" class="w-full px-4 py-2 bg-gray-600 text-white rounded-xl hover:bg-gray-700 transition-colors flex items-center justify-center">
                                <i class="fas fa-list mr-2"></i>Daftar Antrian
                            </a>
                            <a href="<?php echo e(route('admin.antrian.create')); ?>" class="w-full px-4 py-2 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-colors flex items-center justify-center">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\admin\antrian\show.blade.php ENDPATH**/ ?>