            ...
            <div class="flex justify-between items-center py-4">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <div class="flex space-x-2">
                        ...
                        <a href="<?php echo e(route('public.layanan')); ?>" class="public-nav-item active"><i class="fas fa-cogs mr-2"></i>Layanan</a>
                    ...
                    <?php if(Route::has('login')): ?>
                        <div class="flex space-x-4 items-center">
                            <?php if(auth()->guard()->check()): ?>
                                <a href="<?php echo e(url('/dashboard')); ?>" class="public-nav-btn primary">Dashboard</a>
                            <?php else: ?>
                                <a href="<?php echo e(route('login')); ?>" class="public-nav-btn secondary">Masuk</a>
                                <?php if(Route::has('register')): ?>
                                    <a href="<?php echo e(route('register')); ?>" class="public-nav-btn primary">Daftar</a>
                                <?php endif; ?>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
            ...
            <div class="bg-white rounded-xl shadow-sm p-8 fade-in">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div class="bg-gray-50 rounded-lg p-6">
                        ...
                        <form action="<?php echo e(route('public.antrian.store')); ?>" method="POST" class="space-y-4">
                            <?php echo csrf_field(); ?>
                            <div>
                                ...
                                <select name="jenis_layanan" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500" required>
                                    ...
                                    <option value="Surat Pengantar" <?php echo e(old('jenis_layanan') == 'Surat Pengantar' ? 'selected' : ''); ?>>Surat Pengantar KTP</option>
                            ...
                            <div>
                                ...
                                <input type="text" name="nama_lengkap" value="<?php echo e(old('nama_lengkap')); ?>" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500" placeholder="Masukkan nama lengkap" required>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Nomor HP</label>
                                <input type="tel" name="nomor_hp" value="<?php echo e(old('nomor_hp')); ?>" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500" placeholder="Masukkan nomor HP" required>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">NIK</label>
                                <input type="text" name="nik" value="<?php echo e(old('nik')); ?>" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500" placeholder="Masukkan NIK (16 digit)" maxlength="16" required>
                            </div>
                            
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Keperluan (Opsional)</label>
                                <textarea name="keperluan" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500" placeholder="Jelaskan keperluan Anda" rows="3"><?php echo e(old('keperluan')); ?></textarea>
                            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-8 fade-in">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div class="bg-gray-50 rounded-lg p-6">
                        ...
                        <form action="<?php echo e(route('public.pengaduan.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-4">
                            <?php echo csrf_field(); ?>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Jenis Pengaduan *</label>
                                <select name="jenis_pengaduan" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 <?php $__errorArgs = ['jenis_pengaduan'];
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <option value="keluhan" <?php echo e(old('jenis_pengaduan') == 'keluhan' ? 'selected' : ''); ?>>Keluhan Pelayanan</option>
                                    <option value="saran" <?php echo e(old('jenis_pengaduan') == 'saran' ? 'selected' : ''); ?>>Saran Perbaikan</option>
                                    <option value="laporan" <?php echo e(old('jenis_pengaduan') == 'laporan' ? 'selected' : ''); ?>>Laporan Masalah</option>
                                    <option value="informasi" <?php echo e(old('jenis_pengaduan') == 'informasi' ? 'selected' : ''); ?>>Permintaan Informasi</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Nama Lengkap *</label>
                                <input type="text" name="nama_lengkap" value="<?php echo e(old('nama_lengkap')); ?>" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 <?php $__errorArgs = ['nama_lengkap'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="email" name="email" value="<?php echo e(old('email')); ?>" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Nomor HP *</label>
                                <input type="tel" name="nomor_hp" value="<?php echo e(old('nomor_hp')); ?>" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 <?php $__errorArgs = ['nomor_hp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" name="subjek" value="<?php echo e(old('subjek')); ?>" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 <?php $__errorArgs = ['subjek'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Masukkan subjek pengaduan">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <textarea name="isi_pengaduan" rows="4" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 <?php $__errorArgs = ['isi_pengaduan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Jelaskan pengaduan Anda secara detail"><?php echo e(old('isi_pengaduan')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="file" name="lampiran" accept=".jpg,.jpeg,.png,.pdf" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 <?php $__errorArgs = ['lampiran'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
        ...
        <section class="text-center">
            <div class="text-white rounded-xl p-12 fade-in" style="background: #003f88;">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="<?php echo e(route('public.kontak')); ?>" class="bg-white text-primary-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="<?php echo e(route('public.profil')); ?>" class="text-gray-300 hover:text-white transition-colors">Profil</a></li>
                        <li><a href="<?php echo e(route('public.berita')); ?>" class="text-gray-300 hover:text-white transition-colors">Berita</a></li>
                        <li><a href="<?php echo e(route('public.layanan')); ?>" class="text-gray-300 hover:text-white transition-colors">Layanan</a></li>
                        <li><a href="<?php echo e(route('public.kontak')); ?>" class="text-gray-300 hover:text-white transition-colors">Kontak</a></li>
                    </ul>
                </div>
...
</html><?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\public\layanan.blade.php ENDPATH**/ ?>