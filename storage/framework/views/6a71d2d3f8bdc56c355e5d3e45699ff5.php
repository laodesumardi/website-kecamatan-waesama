    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="flex items-center mb-6">
                ...
                <h2 class="text-2xl font-bold" style="color: #001d3d;">Add New Gallery Item</h2>
            </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="description" 
                                  ...
                                  rows="4"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                  placeholder="Enter gallery item description"><?php echo e(old('description')); ?></textarea>
...
<?php endif; ?><?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\admin\galleries\create.blade.php ENDPATH**/ ?>