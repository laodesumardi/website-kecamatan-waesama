...
<div class="p-6">
    ...
    <div class="mb-6">
        <div class="flex items-center gap-4 mb-4">
            <a href="<?php echo e(route('admin.penduduk.show', $penduduk)); ?>" class="text-blue-600 hover:text-blue-800">
                <i class="fas fa-arrow-left text-xl"></i>
            </a>
            <div>
                <h1 class="text-2xl font-bold text-gray-800">Edit Data Penduduk</h1>
                <p class="text-gray-600">Edit data penduduk: <?php echo e($penduduk->nama_lengkap); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm">
        <form action="<?php echo e(route('admin.penduduk.update', $penduduk)); ?>" method="POST" class="p-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="nik" name="nik" value="<?php echo e(old('nik', $penduduk->nik)); ?>" maxlength="16" 
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" id="nama_lengkap" name="nama_lengkap" value="<?php echo e(old('nama_lengkap', $penduduk->nama_lengkap)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" id="tempat_lahir" name="tempat_lahir" value="<?php echo e(old('tempat_lahir', $penduduk->tempat_lahir)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="date" id="tanggal_lahir" name="tanggal_lahir" value="<?php echo e(old('tanggal_lahir', $penduduk->tanggal_lahir->format('Y-m-d'))); ?>" 
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="Laki-laki" <?php echo e(old('jenis_kelamin', $penduduk->jenis_kelamin == 'L' ? 'Laki-laki' : ($penduduk->jenis_kelamin == 'P' ? 'Perempuan' : $penduduk->jenis_kelamin)) == 'Laki-laki' ? 'selected' : ''); ?>>Laki-laki</option>
                            <option value="Perempuan" <?php echo e(old('jenis_kelamin', $penduduk->jenis_kelamin == 'L' ? 'Laki-laki' : ($penduduk->jenis_kelamin == 'P' ? 'Perempuan' : $penduduk->jenis_kelamin)) == 'Perempuan' ? 'selected' : ''); ?>>Perempuan</option>
                        </select>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="pendidikan" name="pendidikan" value="<?php echo e(old('pendidikan', $penduduk->pendidikan)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" id="pekerjaan" name="pekerjaan" value="<?php echo e(old('pekerjaan', $penduduk->pekerjaan)); ?>" 
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="no_kk" name="no_kk" value="<?php echo e(old('no_kk', $penduduk->no_kk)); ?>" maxlength="16" 
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" id="hubungan_keluarga" name="hubungan_keluarga" value="<?php echo e(old('hubungan_keluarga', $penduduk->hubungan_keluarga)); ?>" 
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('alamat', $penduduk->alamat)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="rt" name="rt" value="<?php echo e(old('rt', $penduduk->rt)); ?>" maxlength="3" 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="rw" name="rw" value="<?php echo e(old('rw', $penduduk->rw)); ?>" maxlength="3" 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="desa_kelurahan" name="desa_kelurahan" value="<?php echo e(old('desa_kelurahan', $penduduk->desa_kelurahan)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="kode_pos" name="kode_pos" value="<?php echo e(old('kode_pos', $penduduk->kode_pos)); ?>" maxlength="5" 
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="kecamatan" name="kecamatan" value="<?php echo e(old('kecamatan', $penduduk->kecamatan)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="kabupaten_kota" name="kabupaten_kota" value="<?php echo e(old('kabupaten_kota', $penduduk->kabupaten_kota)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="provinsi" name="provinsi" value="<?php echo e(old('provinsi', $penduduk->provinsi)); ?>" 
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="Tetap" <?php echo e(old('status_penduduk', $penduduk->status_penduduk) == 'Tetap' ? 'selected' : ''); ?>>Tetap</option>
                            <option value="Pindah" <?php echo e(old('status_penduduk', $penduduk->status_penduduk) == 'Pindah' ? 'selected' : ''); ?>>Pindah</option>
                            <option value="Meninggal" <?php echo e(old('status_penduduk', $penduduk->status_penduduk) == 'Meninggal' ? 'selected' : ''); ?>>Meninggal</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex justify-end space-x-4 pt-6 border-t">
                <a href="<?php echo e(route('admin.penduduk.show', $penduduk)); ?>" class="px-6 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors">
                    Batal
                </a>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\admin\penduduk\edit.blade.php ENDPATH**/ ?>