<div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-yellow-900"><?php echo e(number_format($data['pending'] ?? 0)); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-orange-50 p-4 rounded-lg border border-orange-200">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-orange-900"><?php echo e(number_format($data['processing'] ?? 0)); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-green-50 p-4 rounded-lg border border-green-200">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-green-900"><?php echo e(number_format($data['resolved'] ?? 0)); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-red-50 p-4 rounded-lg border border-red-200">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-red-900"><?php echo e(number_format($data['rejected'] ?? 0)); ?></p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center">
                        <div class="w-32 bg-gray-200 rounded-full h-2 mr-3">
                            <div class="bg-red-500 h-2 rounded-full" style="width: <?php echo e($category['percentage']); ?>%"></div>
                        </div>
        ...
        <div class="bg-gray-50 p-4 rounded-lg">
            ...
            <div class="space-y-4">
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-lg font-semibold text-gray-800"><?php echo e($data['avg_response_time'] ?? '0'); ?> hari</span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-sm text-gray-600">Respons Tercepat</span>
                    <span class="text-lg font-semibold text-green-600"><?php echo e($data['min_response_time'] ?? '0'); ?> hari</span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-sm text-gray-600">Respons Terlama</span>
                    <span class="text-lg font-semibold text-red-600"><?php echo e($data['max_response_time'] ?? '0'); ?> hari</span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-sm text-gray-600">Rata-rata Waktu Penyelesaian</span>
                    <span class="text-lg font-semibold text-blue-600"><?php echo e($data['avg_resolution_time'] ?? '0'); ?> hari</span>
                </div>
                <div class="pt-2 border-t">
                    <div class="text-sm text-gray-600 mb-2">Distribusi Waktu Respons:</div>
                    <?php $__currentLoopData = $data['response_time_distribution'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $range): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex justify-between items-center mb-1">
                        <span class="text-xs text-gray-500"><?php echo e($range['label']); ?></span>
                        <span class="text-xs font-medium"><?php echo e($range['count']); ?> pengaduan</span>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div class="bg-gray-50 p-4 rounded-lg">
            ...
            <div class="space-y-3">
                <?php $__currentLoopData = $data['priorities'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $priority): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <span class="w-3 h-3 rounded-full mr-2" style="background-color: <?php echo e($priority['color']); ?>"></span>
                        <span class="text-sm text-gray-600"><?php echo e($priority['name']); ?></span>
                    </div>
                    <div class="flex items-center">
                        <div class="w-32 bg-gray-200 rounded-full h-2 mr-3">
                            <div class="h-2 rounded-full" style="width: <?php echo e($priority['percentage']); ?>%; background-color: <?php echo e($priority['color']); ?>"></div>
                        </div>
                        <span class="text-sm font-medium text-gray-800"><?php echo e(number_format($priority['count'])); ?> (<?php echo e($priority['percentage']); ?>%)</span>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        ...
        <div class="bg-gray-50 p-4 rounded-lg">
            ...
            <div class="space-y-4">
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-lg font-semibold text-green-600"><?php echo e($data['resolution_rate'] ?? '0'); ?>%</span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-sm text-gray-600">Tingkat Kepuasan</span>
                    <span class="text-lg font-semibold text-blue-600"><?php echo e($data['satisfaction_rate'] ?? '0'); ?>%</span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-sm text-gray-600">Pengaduan Berulang</span>
                    <span class="text-lg font-semibold text-orange-600"><?php echo e($data['repeat_complaints'] ?? '0'); ?>%</span>
                </div>
                <div class="pt-2 border-t">
                    <div class="text-sm text-gray-600 mb-2">Efektivitas Penanganan:</div>
                    <div class="w-full bg-gray-200 rounded-full h-3">
                        <div class="bg-green-500 h-3 rounded-full" style="width: <?php echo e($data['handling_effectiveness'] ?? 0); ?>%"></div>
                    </div>
                    <div class="text-center text-sm font-medium text-gray-800 mt-1"><?php echo e($data['handling_effectiveness'] ?? '0'); ?>%</div>
                </div>
            </div>
        </div>
    </div>
...
if (document.getElementById('complaintsStatusChart')) {
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                data: [
                    <?php echo e($data['pending'] ?? 0); ?>,
                    <?php echo e($data['processing'] ?? 0); ?>,
                    <?php echo e($data['resolved'] ?? 0); ?>,
                    <?php echo e($data['rejected'] ?? 0); ?>
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: <?php echo json_encode(array_column($data['monthly_stats'] ?? [], 'count')); ?>,
...
</script><?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\admin\laporan\complaints.blade.php ENDPATH**/ ?>