<?php $__env->startSection('title', 'Tambah Surat Baru'); ?>
...
<div class="p-6">
    ...
    <div class="mb-6">
        <div class="flex items-center gap-4 mb-4">
            <a href="<?php echo e(route('admin.surat.index')); ?>" class="text-blue-600 hover:text-blue-800">
                <i class="fas fa-arrow-left text-xl"></i>
            </a>
            <div>
                <h1 class="text-2xl font-bold text-gray-800">Tambah Surat Baru</h1>
                <p class="text-gray-600">Buat permohonan surat baru untuk masyarakat</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm">
        <form action="<?php echo e(route('admin.surat.store')); ?>" method="POST" class="p-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="Domisili" <?php echo e(old('jenis_surat') == 'Domisili' ? 'selected' : ''); ?>>Surat Keterangan Domisili</option>
                            <option value="SKTM" <?php echo e(old('jenis_surat') == 'SKTM' ? 'selected' : ''); ?>>Surat Keterangan Tidak Mampu</option>
                            <option value="Usaha" <?php echo e(old('jenis_surat') == 'Usaha' ? 'selected' : ''); ?>>Surat Keterangan Usaha</option>
                            <option value="Pengantar" <?php echo e(old('jenis_surat') == 'Pengantar' ? 'selected' : ''); ?>>Surat Pengantar</option>
                            <option value="Kematian" <?php echo e(old('jenis_surat') == 'Kematian' ? 'selected' : ''); ?>>Surat Keterangan Kematian</option>
                            <option value="Kelahiran" <?php echo e(old('jenis_surat') == 'Kelahiran' ? 'selected' : ''); ?>>Surat Keterangan Kelahiran</option>
                            <option value="Pindah" <?php echo e(old('jenis_surat') == 'Pindah' ? 'selected' : ''); ?>>Surat Keterangan Pindah</option>
                        </select>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="nama_pemohon" name="nama_pemohon" value="<?php echo e(old('nama_pemohon')); ?>" 
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" id="nik_pemohon" name="nik_pemohon" value="<?php echo e(old('nik_pemohon')); ?>" maxlength="16" 
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" id="phone_pemohon" name="phone_pemohon" value="<?php echo e(old('phone_pemohon')); ?>" 
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('alamat_pemohon')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div id="data-tambahan-section" class="mb-8" style="display: none;">
            ...
            <div class="flex justify-end space-x-4 pt-6 border-t">
                <a href="<?php echo e(route('admin.surat.index')); ?>" class="px-6 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors">
                    Batal
                </a>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="data_tambahan[jenis_pengantar]" 
                                ...
                                <option value="KK">Pengantar KK</option>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\admin\surat\create.blade.php ENDPATH**/ ?>