<?php $__env->startSection('title', 'Akses Ditolak - 403'); ?>
    ...
    <div class="max-w-md w-full mx-4">
        <div class="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <p class="text-gray-600 mb-8 leading-relaxed">
                <?php echo e($message ?? 'Anda tidak memiliki izin untuk mengakses halaman ini.'); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\errors\403.blade.php ENDPATH**/ ?>