...
<head>
    ...
    <title><?php echo e($title ?? 'Dashboard'); ?> - Kantor Camat Waesama</title>
    ...
    <script src="<?php echo e(asset('js/csrf-handler.js')); ?>"></script>
    ...
    <div class="h-screen overflow-hidden">
        ...
        <div id="sidebar" class="sidebar-transition sidebar-expanded bg-primary shadow-xl border-r border-primary-700 flex flex-col">
            ...
            <div class="p-4 border-b border-primary-700">
                <div class="flex items-center space-x-3">
                    ...
                    <div id="user-info" class="sidebar-transition">
                        <p class="font-medium text-white text-sm"><?php echo e(auth()->user()->name); ?></p>
                        <p class="text-xs text-primary-200"><?php echo e(auth()->user()->role->display_name); ?></p>
                    </div>
                </div>
            </div>
            ...
            <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
                ...
                <?php elseif(auth()->user()->role->name === 'Pegawai'): ?>
                    <?php echo $__env->make('partials.pegawai-sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php elseif(auth()->user()->role->name === 'Warga'): ?>
                    <?php echo $__env->make('partials.warga-sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php endif; ?>
            </nav>
    ...
    <header class="bg-primary shadow-sm border-b border-primary-700 py-4">
        <div class="flex items-center justify-between px-6">
            ...
            <div class="flex-1 lg:flex-none">
                <h1 class="text-xl lg:text-2xl font-bold text-white"><?php echo e($title ?? 'Dashboard'); ?></h1>
                <?php if(isset($subtitle)): ?>
                    <p class="text-primary-200 text-sm mt-1"><?php echo e($subtitle); ?></p>
                <?php endif; ?>
            </div>
                    ...
                    <div id="profile-dropdown" class="absolute right-0 mt-2 w-48 bg-primary-800 rounded-lg shadow-lg border border-primary-600 z-50 hidden profile-dropdown">
                        <div class="p-2">
                            <div class="px-3 py-2 border-b border-primary-600">
                                <p class="font-medium text-white"><?php echo e(auth()->user()->name); ?></p>
                                <p class="text-sm text-primary-200"><?php echo e(auth()->user()->email); ?></p>
                                <p class="text-xs text-primary-300"><?php echo e(auth()->user()->role->display_name); ?></p>
                            </div>
                            <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center px-3 py-2 text-sm text-white hover:bg-primary-700 rounded-md">
...
<?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\layouts\main.blade.php ENDPATH**/ ?>