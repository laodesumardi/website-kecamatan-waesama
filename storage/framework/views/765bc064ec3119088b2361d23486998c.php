...
if (document.getElementById('populationTrendChart')) {
    ...
    new Chart(ctx, {
        type: 'line',
        data: {
            labels: <?php echo json_encode(collect($data['daily_registrations'] ?? [])->pluck('date')->toArray()); ?>,
            datasets: [{
                label: 'Pendaftaran Harian',
                data: <?php echo json_encode(collect($data['daily_registrations'] ?? [])->pluck('count')->toArray()); ?>,
...
</script><?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\admin\laporan\partials\penduduk.blade.php ENDPATH**/ ?>