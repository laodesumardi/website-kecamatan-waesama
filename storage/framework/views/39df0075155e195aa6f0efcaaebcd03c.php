...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm">
        <form action="<?php echo e(route('admin.berita.store')); ?>" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                  placeholder="Ringkasan singkat berita (opsional)"><?php echo e(old('excerpt')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                  placeholder="Tulis konten berita lengkap di sini..." required><?php echo e(old('konten')); ?></textarea>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\admin\berita\create.blade.php ENDPATH**/ ?>