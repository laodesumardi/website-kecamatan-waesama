<?php $__env->startSection('title', 'Antrian Online'); ?>
...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="<?php echo e(route('warga.antrian.create')); ?>" 
        ...
        <div class="bg-white rounded-lg shadow-sm border p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($todayStats['total_antrian']); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($todayStats['antrian_menunggu']); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($todayStats['antrian_proses']); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($todayStats['antrian_selesai']); ?></p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__currentLoopData = $antrianList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $antrian): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <div class="text-sm text-gray-500"><?php echo e(Str::limit($antrian->keperluan, 50)); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900"><?php echo e($antrian->tanggal_kunjungan->format('d M Y')); ?></div>
                                    <div class="text-sm text-gray-500"><?php echo e($antrian->jam_kunjungan->format('H:i')); ?> WIB</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <?php
                                        $statusColors = [
                                            'Menunggu' => 'bg-yellow-100 text-yellow-800',
                                            'Sedang Dilayani' => 'bg-primary-100 text-primary-800',
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <?php if($antrian->status === 'Menunggu' && $antrian->tanggal_kunjungan >= today()): ?>
                                        <form action="<?php echo e(route('warga.antrian.cancel', $antrian->id)); ?>" method="POST" class="inline"
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\warga\antrian\index.blade.php ENDPATH**/ ?>