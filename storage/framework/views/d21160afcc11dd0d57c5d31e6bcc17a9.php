...
<head>
    ...
    <title>Login - <?php echo e(config('app.name', 'Kantor Camat Waesama')); ?></title>
                    ...
                    <?php if(Route::has('register')): ?>
                        <div class="text-center pt-4 border-t border-gray-200">
                            <p class="text-sm text-gray-600">
                                Belum punya akun?
                                <a href="<?php echo e(route('register')); ?>" class="link-primary font-medium">
                                    Daftar sekarang
                                </a>
                            </p>
                        </div>
...
<?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\auth\login.blade.php ENDPATH**/ ?>