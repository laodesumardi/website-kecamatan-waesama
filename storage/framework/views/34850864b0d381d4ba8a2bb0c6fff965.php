        ...
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex space-x-3">
                <?php if($surat->status !== 'Selesai'): ?>
                    <a href="<?php echo e(route('admin.surat.edit', $surat)); ?>" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
                        <i class="fas fa-edit mr-2"></i>Edit
                    </a>
                <?php endif; ?>
                
                <?php if($surat->status === 'Selesai'): ?>
                    <a href="<?php echo e(route('admin.surat.download', $surat)); ?>" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors">
                        <i class="fas fa-download mr-2"></i>Download
                    </a>
                <?php endif; ?>
                
                <form action="<?php echo e(route('admin.surat.destroy', $surat)); ?>" method="POST" class="inline" 
        ...
        <div class="lg:col-span-1">
            ...
            <div class="bg-white rounded-lg shadow-sm mb-6">
                <div class="p-6">
                    ...
                    <div class="mt-6 space-y-2">
                        ...
                        <form action="<?php echo e(route('admin.surat.process', $surat)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                        ...
                        <form action="<?php echo e(route('admin.surat.complete', $surat)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
            ...
            <div class="bg-white rounded-lg shadow-sm">
                <div class="p-6">
                    ...
                    <div class="space-y-2">
                        <?php if($surat->status !== 'Selesai'): ?>
                        <a href="<?php echo e(route('admin.surat.edit', $surat)); ?>" class="w-full px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm text-center block">
                            <i class="fas fa-edit mr-2"></i>Edit Surat
                        </a>
                        <?php endif; ?>
                        
                        <?php if($surat->status === 'Selesai'): ?>
                        <a href="<?php echo e(route('admin.surat.download', $surat)); ?>" class="w-full px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors text-sm text-center block">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\admin\surat\show.blade.php ENDPATH**/ ?>