<?php $__env->startSection('title', 'Bookmark Berita'); ?>
...
<div class="container mx-auto px-4 py-6">
    ...
    <div id="newsGrid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        <?php echo $__env->make('warga.partials.berita-grid', ['berita' => $bookmarks], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>

    <!-- Pagination -->
    <?php if($bookmarks->hasPages()): ?>
                                ...
                                newsContainer.innerHTML = `
                                    <div class="col-span-full">
                                        <div class="text-center py-12">
                                            ...
                                            <a href="<?php echo e(route('warga.berita.index')); ?>" class="inline-block mt-4 bg-primary-600 text-white px-4 py-2 rounded-lg hover:bg-primary-700 transition-colors">
                                                Jelajahi Berita
                                            </a>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\kantor-camat-waesama\resources\views\warga\bookmarks.blade.php ENDPATH**/ ?>