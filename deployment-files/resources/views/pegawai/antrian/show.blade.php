...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-xl card-shadow p-6">
            ...
            <div class="space-y-3">
                @if($antrian->status === 'Menunggu')
                    <form action="{{ route('pegawai.antrian.call', $antrian) }}" method="POST">
                        @csrf
                    ...
                    <form action="{{ route('pegawai.antrian.serve', $antrian) }}" method="POST">
                        @csrf
                    ...
                    <form action="{{ route('pegawai.antrian.cancel', $antrian) }}" method="POST">
                        @csrf
                ...
                @elseif($antrian->status === 'Dilayani')
                    <form action="{{ route('pegawai.antrian.complete', $antrian) }}" method="POST">
                        @csrf
        ...
        <div class="bg-white rounded-xl card-shadow p-6">
            ...
            <div class="space-y-3">
                <a href="{{ route('pegawai.antrian.index') }}" class="w-full px-4 py-2 bg-gray-600 text-white rounded-xl hover:bg-gray-700 transition-colors flex items-center justify-center">
                    <i class="fas fa-list mr-2"></i>Daftar Antrian
                </a>
                <a href="{{ route('pegawai.dashboard') }}" class="w-full px-4 py-2 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-colors flex items-center justify-center">
