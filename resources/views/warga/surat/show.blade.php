    ...
    <div class="mb-6">
        <div class="flex items-center justify-between mb-4">
            <div class="flex items-center gap-4">
                <a href="{{ route('warga.surat.index') }}" class="text-blue-600 hover:text-blue-800">
            ...
            <div class="flex space-x-3">
                @if($surat->status === 'Selesai' && $surat->file_surat)
                    <a href="{{ route('warga.surat.download', $surat) }}" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors">
        ...
        <div class="lg:col-span-1">
            ...
            <div class="bg-white rounded-lg shadow-sm">
                <div class="p-6">
                    ...
                    <div class="space-y-2">
                        @if($surat->status === 'Selesai' && $surat->file_surat)
                        <a href="{{ route('warga.surat.download', $surat) }}" class="w-full px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors text-sm text-center block">
