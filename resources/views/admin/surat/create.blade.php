    ...
    <div class="bg-white rounded-lg shadow-sm">
        <form action="{{ route('admin.surat.store') }}" method="POST" class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select id="jenis_surat" name="jenis_surat" 
                            ...
                            <option value="Pengantar" {{ old('jenis_surat') == 'Pengantar' ? 'selected' : '' }}>Surat Pengantar</option>
                            <option value="Kematian" {{ old('jenis_surat') == 'Kematian' ? 'selected' : '' }}>Surat Keterangan Kematian</option>
                            <option value="Kelahiran" {{ old('jenis_surat') == 'Kelahiran' ? 'selected' : '' }}>Surat Keterangan Kelahiran</option>
                            <option value="Pindah" {{ old('jenis_surat') == 'Pindah' ? 'selected' : '' }}>Surat Keterangan Pindah</option>
                        </select>
                        @error('jenis_surat')
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="nik_pemohon" name="nik_pemohon" value="{{ old('nik_pemohon') }}" maxlength="16" 
                    ...
                    <div>
                        ...
                        <input type="text" id="phone_pemohon" name="phone_pemohon" value="{{ old('phone_pemohon') }}" 
                ...
                <div class="mt-6">
                    ...
                    <textarea id="alamat_pemohon" name="alamat_pemohon" rows="3" 
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('alamat_pemohon') border-red-500 @enderror">{{ old('alamat_pemohon') }}</textarea>
            ...
            <div class="mb-8">
                ...
                <div>
                    ...
                    <textarea id="keperluan" name="keperluan" rows="4" 
                              ...
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('keperluan') border-red-500 @enderror">{{ old('keperluan') }}</textarea>
                    @error('keperluan')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="flex justify-end space-x-4 pt-6 border-t">
                <a href="{{ route('admin.surat.index') }}" class="px-6 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors">
                    Batal
                </a>
