                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            @if($news->image)
                                <div>
                                    ...
                                    <img src="{{ asset('storage/' . $news->image) }}" alt="{{ $news->title }}" class="h-32 w-32 object-cover rounded border">
                                </div>
                            @endif

                            <!-- New Image -->
                            <div class="{{ $news->image ? '' : 'md:col-span-2' }}">
                                <label for="image" class="block text-sm font-medium text-gray-700 mb-2">{{ $news->image ? 'Ganti Gambar (Opsional)' : 'Gambar (Opsional)' }}</label>
