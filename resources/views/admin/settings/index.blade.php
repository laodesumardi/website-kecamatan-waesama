...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl p-6 card-shadow">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <a href="{{ route('admin.settings.backup') }}" class="w-full bg-green-600 hover:bg-green-700 text-[#ffc300] px-4 py-3 rounded-lg flex items-center justify-center space-x-2 transition-colors">
                <i class="fas fa-download"></i>
                <span>Backup Database</span>
            </a>

            <a href="{{ route('admin.settings.system-info') }}" class="w-full bg-purple-600 hover:bg-purple-700 text-[#ffc300] px-4 py-3 rounded-lg flex items-center justify-center space-x-2 transition-colors">
