...
<div class="p-6">
    ...
    <div class="mb-6">
        <div class="flex items-center gap-4 mb-4">
            <a href="{{ route('admin.penduduk.show', $penduduk) }}" class="text-blue-600 hover:text-blue-800">
                <i class="fas fa-arrow-left text-xl"></i>
            </a>
            <div>
                <h1 class="text-2xl font-bold text-gray-800">Edit Data Penduduk</h1>
                <p class="text-gray-600">Edit data penduduk: {{ $penduduk->nama_lengkap }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm">
        <form action="{{ route('admin.penduduk.update', $penduduk) }}" method="POST" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="nik" name="nik" value="{{ old('nik', $penduduk->nik) }}" maxlength="16" 
                    ...
                    <div>
                        ...
                        <input type="text" id="nama_lengkap" name="nama_lengkap" value="{{ old('nama_lengkap', $penduduk->nama_lengkap) }}" 
                    ...
                    <div>
                        ...
                        <input type="date" id="tanggal_lahir" name="tanggal_lahir" value="{{ old('tanggal_lahir', $penduduk->tanggal_lahir->format('Y-m-d')) }}" 
                    ...
                    <div>
                        ...
                        <select id="jenis_kelamin" name="jenis_kelamin" 
                            ...
                            <option value="Laki-laki" {{ old('jenis_kelamin', $penduduk->jenis_kelamin == 'L' ? 'Laki-laki' : ($penduduk->jenis_kelamin == 'P' ? 'Perempuan' : $penduduk->jenis_kelamin)) == 'Laki-laki' ? 'selected' : '' }}>Laki-laki</option>
                            <option value="Perempuan" {{ old('jenis_kelamin', $penduduk->jenis_kelamin == 'L' ? 'Laki-laki' : ($penduduk->jenis_kelamin == 'P' ? 'Perempuan' : $penduduk->jenis_kelamin)) == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                        </select>
                        @error('jenis_kelamin')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="no_kk" name="no_kk" value="{{ old('no_kk', $penduduk->no_kk) }}" maxlength="16" 
                    ...
                    <div>
                        ...
                        <input type="text" id="hubungan_keluarga" name="hubungan_keluarga" value="{{ old('hubungan_keluarga', $penduduk->hubungan_keluarga) }}" 
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <textarea id="alamat" name="alamat" rows="3" 
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('alamat') border-red-500 @enderror">{{ old('alamat', $penduduk->alamat) }}</textarea>
                        @error('alamat')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="rt" name="rt" value="{{ old('rt', $penduduk->rt) }}" maxlength="3" 
                        ...
                        <div>
                            ...
                            <input type="text" id="rw" name="rw" value="{{ old('rw', $penduduk->rw) }}" maxlength="3" 
                        ...
                        <div>
                            ...
                            <input type="text" id="desa_kelurahan" name="desa_kelurahan" value="{{ old('desa_kelurahan', $penduduk->desa_kelurahan) }}" 
                        ...
                        <div>
                            ...
                            <input type="text" id="kode_pos" name="kode_pos" value="{{ old('kode_pos', $penduduk->kode_pos) }}" maxlength="5" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="kabupaten_kota" name="kabupaten_kota" value="{{ old('kabupaten_kota', $penduduk->kabupaten_kota) }}" 
            ...
            <div class="flex justify-end space-x-4 pt-6 border-t">
                <a href="{{ route('admin.penduduk.show', $penduduk) }}" class="px-6 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors">
                    Batal
                </a>
